...
public class SkyColorLayer extends RenderableLayer {
    ...
    private double fadeBottomAltitude = 50.0e3;
    private double fadeTopAltitude = 140.0e3;
    ...
    public void doRender(DrawContext dc) {
        ...
        try {
            ...
            // Set color
            Color cc = this.color;
            gl.glColor4d(cc.getRed() / 255.0f * fadeFactor,
                cc.getGreen() / 255.0f * fadeFactor,
                cc.getBlue() / 255.0f * fadeFactor,
                cc.getAlpha() / 255.0f * fadeFactor);
            // Draw
