...
public abstract class KMLAbstractBalloon implements Balloon, WebResourceResolver, PropertyChangeListener {
     ...
     * gov.nasa.worldwind.examples.ogc.kml.io.KMLDoc#getSupportFilePath(String)}</code> on the parent
    ...
    public Object set(String key, Object value) {
        return this.getBalloon().set(key, value);
    }
    ...
    public Object get(String key) {
        return this.getBalloon().get(key);
    }
