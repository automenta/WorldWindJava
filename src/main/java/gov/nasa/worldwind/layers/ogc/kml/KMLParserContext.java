...
import gov.nasa.worldwind.layers.ogc.kml.gx.GXParserContext;
...
public class KMLParserContext extends BasicXMLEventParserContext {
     ...
     *
     * @param defaultNamespace the default namespace. If null, {@link KMLConstants#KML_NAMESPACE} is used.
     */
    ...
    protected void initializeParsers() {
        ...
        this.parsers.put(KMLParserContext.COORDINATES, new KMLCoordinatesParser());
    ...
    protected void initializeParsers(String ns) {
        ...
        this.addStringParsers(ns, KMLParserContext.StringFields);
        this.addDoubleParsers(ns, KMLParserContext.DoubleFields);
        this.addIntegerParsers(ns, KMLParserContext.IntegerFields);
        this.addBooleanParsers(ns, KMLParserContext.BooleanFields);
    }
    ...
    public KMLCoordinatesParser getCoordinatesParser() {
        if (this.coordinatesParser == null)
            this.coordinatesParser = (KMLCoordinatesParser) this.getParser(KMLParserContext.COORDINATES);
