...
public class MipMappedBufferedImageRaster extends BufferedImageRaster {
    ...
    public MipMappedBufferedImageRaster(Sector sector, BufferedImage image) {
        ...
        BufferedImage[] levelImages = ImageUtil.buildMipmaps(image,
            BufferedImage.TYPE_INT_ARGB_PRE, maxLevel);
     ...
     */
    public MipMappedBufferedImageRaster(Sector sector, BufferedImage[] images) {
