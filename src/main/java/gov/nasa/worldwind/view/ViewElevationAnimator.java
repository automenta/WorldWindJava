...
public class ViewElevationAnimator extends DoubleAnimator {
     ...
     * data available.
     *
     * @param globe            Globe used to evaluate altitude mode and determine if mid-zoom is necessary. May be
     *                         null.
     ...
     * @param altitudeMode     Altitude mode of ending elevation ({@link WorldWind#CLAMP_TO_GROUND}, {@link
     *                         WorldWind#RELATIVE_TO_GROUND}, or {@link WorldWind#ABSOLUTE}. Altitude mode is not used
     *                         if {@code globe} is null.
