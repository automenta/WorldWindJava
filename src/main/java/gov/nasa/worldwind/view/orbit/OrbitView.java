...
public interface OrbitView extends View {
    String CENTER_STOPPED = "gov.nasa.worldwind.view.orbit.OrbitView.CenterStopped";
    ...
    /**
     * Returns whether or not a collision has occurred since the last call to <code>hadCollisions</code>. If {@link
     * #isDetectCollisions} is false, collisions will not be detected and
     ...
     * pitch rotate.  It is defined by the intersection of a ray from the eye position through the center of the
