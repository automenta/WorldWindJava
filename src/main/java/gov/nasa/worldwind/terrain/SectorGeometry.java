...
public interface SectorGeometry extends Renderable {
     ...
     * {@link #endRendering(DrawContext)} method must be called.
     *
     * @param dc              the current draw context.
    ...
    /**
     * Restores state established by {@link #beginRendering(DrawContext, int)}.
     *
     * @param dc the current draw context.
     */
     ...
     * @throws IllegalArgumentException if either the draw context or list of pick points is null.
     */
    PickedObject[] pick(DrawContext dc, List<? extends Point> pickPoints);
     ...
     *                             that it was not. Calling &lt;beginRendering&gt; eliminates redundant rendering set-up
     *                             and is used when this sector geometry is rendered several times in succession.
     * @throws IllegalArgumentException if the draw context is null or the number of texture units is less than one.
     * @see #beginRendering(DrawContext, int)
     */
     ...
     */
    interface GeographicTextureCoordinateComputer {
        /**
