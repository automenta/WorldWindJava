...
public class DefaultLabelLayouts {
    ...
    protected void populateMap() {
        ...
        this.layouts.put(C2GM_GNL_PNT_HBR,
            DefaultLabelLayouts.createLayout(SymbologyConstants.ADDITIONAL_INFORMATION, Offset.CENTER, Offset.CENTER));
        ...
        DefaultLabelLayouts.addLayout(layout, SymbologyConstants.ADDITIONAL_INFORMATION,
            Offset.TOP_CENTER,
            Offset.BOTTOM_CENTER);
        DefaultLabelLayouts.addLayout(layout, SymbologyConstants.HOSTILE_ENEMY,
            Offset.fromFraction(1.1, 0.35),
            Offset.fromFraction(0.0, 0.0));
        DefaultLabelLayouts.addLayout(layout, SymbologyConstants.DATE_TIME_GROUP,
        ...
        DefaultLabelLayouts.addLayout(layout, SymbologyConstants.LOCATION,
        ...
        DefaultLabelLayouts.addLayout(layout, SymbologyConstants.HOSTILE_ENEMY,
            Offset.fromFraction(1.0, 0.0),
            Offset.fromFraction(0.0, 0.0));
        DefaultLabelLayouts.addLayout(layout, SymbologyConstants.TYPE,
            Offset.LEFT_CENTER,
            Offset.RIGHT_CENTER);
        DefaultLabelLayouts.addLayout(layout, SymbologyConstants.UNIQUE_DESIGNATION,
            Offset.fromFraction(0.0, 0.0),
        ...
        layout = new ArrayList<>(layout);
        DefaultLabelLayouts.addLayout(layout, SymbologyConstants.QUANTITY,
            Offset.TOP_CENTER,
            Offset.BOTTOM_CENTER);
        this.layouts.put(MOBSU_CBRN_NDGZ, layout);

        // C2GM.GNL.PNT.REFPNT.PNTINR supports the T modifier
        layout = DefaultLabelLayouts.createLayout(SymbologyConstants.UNIQUE_DESIGNATION,
        ...
        layout = DefaultLabelLayouts.createLayout(SymbologyConstants.ALTITUDE_DEPTH,
            Offset.fromFraction(0.75, 0.75),
            Offset.fromFraction(0.0, 0.0));
