...
public class FireSupportTextBuilder {
    ...
    protected static boolean isShowSeparateTimeLabel(String maskedSidc) {
    ...
    protected static boolean isShowAltitude(String maskedSidc) {
    ...
    protected static boolean isAirspaceCoordinationArea(String functionId) {
    ...
    protected static String createTimeRangeText(TacticalGraphic graphic) {
        StringBuilder sb = new StringBuilder();
    ...
    protected static String getGraphicLabel(String sidc) {
    ...
    protected static String createAirspaceCoordinationText(TacticalGraphic graphic) {
        StringBuilder sb = new StringBuilder();
        sb.append("ACA\n");
