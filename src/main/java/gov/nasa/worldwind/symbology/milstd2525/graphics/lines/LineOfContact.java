...
public class LineOfContact extends ForwardLineOfOwnTroops {
    ...
    public static void generateParallelLines(Iterator<? extends Position> iterator, Collection<Position> leftPositions,
        ...
        LineOfContact.generateParallelPoints(ptB, null, ptA, leftPositions, rightPositions, halfWidth, globe);
     ...
     * @param globe          Current globe.
     */
    protected static void generateParallelPoints(Vec4 point, Vec4 prev, Vec4 next, Collection<Position> leftPositions,
        Collection<Position> rightPositions, double halfWidth, Globe globe) {
