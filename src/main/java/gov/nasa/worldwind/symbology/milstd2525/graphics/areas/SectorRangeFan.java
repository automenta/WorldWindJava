...
public class SectorRangeFan extends AbstractMilStd2525TacticalGraphic implements PreRenderable {
    ...
    protected void createShapes(DrawContext dc) {
        ...
        while (radii.hasNext()) {
            ...
            leftAzimuth = SectorRangeFan.normalizeAzimuth(leftAzimuth);
            rightAzimuth = SectorRangeFan.normalizeAzimuth(rightAzimuth);
    ...
    protected void createCenterOfSectorArrow(DrawContext dc, Angle centerAzimuth, double finalRadius) {
        ...
        positions = SectorRangeFan.computeArrowheadPositions(dc, center, arrowTip, this.getArrowLength(),
            this.getArrowAngle());
    ...
    protected void determineLabelPositions(DrawContext dc) {
        ...
        while (radii.hasNext() && labelIterator.hasNext()) {
            ...
            double offset = SectorRangeFan.computeAzimuthLabelOffset(avgRadius, this.maxRadius);
