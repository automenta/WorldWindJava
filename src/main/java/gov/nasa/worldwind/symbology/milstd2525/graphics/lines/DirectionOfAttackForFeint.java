...
public class DirectionOfAttackForFeint extends DirectionOfAttack {
     ...
     */
    protected int intervals = DirectionOfAttackForFeint.DEFAULT_NUM_INTERVALS;
    /**
     * Factor that controls the curve of the line. Valid values are 0 to 1. Larger values result in a more pronounced
     * curve.
     */
    protected double curvature = DirectionOfAttackForFeint.DEFAULT_CURVATURE;
    /**
    ...
    public DirectionOfAttackForFeint(String sidc) {
        super(sidc);
        this.setArrowAngle(DirectionOfAttackForFeint.DEFAULT_ARROWHEAD_ANGLE);
    }
     ...
     */
    protected static Vec4[] computeBezierControlPoints(DrawContext dc, Vec4 start, Vec4 end, double curvature) {
    ...
    protected void createShapes(DrawContext dc) {
        ...
        Vec4[] controlPoints = DirectionOfAttackForFeint.computeBezierControlPoints(dc, pt1, pt2, this.getCurvature());
        ...
        pt2 = pt2.subtract3(dir.normalize3().multiply3(arrowheadLength * DirectionOfAttackForFeint.DASHED_LINE_DISTANCE));
        ...
        positions = this.computeArrowheadPositions(dc, pt2, dir, arrowheadLength * (1 + DirectionOfAttackForFeint.DASHED_LINE_DISTANCE));
    ...
    protected void determineActiveAttributes() {
        ...
        this.dashedAttributes.setOutlineStipplePattern(AbstractMilStd2525TacticalGraphic.getOutlineStipplePattern());
        this.dashedAttributes.setOutlineStippleFactor(AbstractMilStd2525TacticalGraphic.getOutlineStippleFactor());
    }
    ...
    protected void createLabels() {
        ...
        if (!WWUtil.isEmpty(text)) {
            ...
            label.setOffset(DirectionOfAttackForFeint.LABEL_OFFSET);
        }
    }
    ...
    protected Offset getDefaultLabelOffset() {
        return DirectionOfAttackForFeint.LABEL_OFFSET;
    }
}