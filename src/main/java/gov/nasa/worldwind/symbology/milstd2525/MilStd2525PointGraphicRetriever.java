...
public class MilStd2525PointGraphicRetriever extends AbstractIconRetriever {
    ...
    protected static String composeFilename(SymbolCode code) {
        ...
        if (SymbologyConstants.SCHEME_TACTICAL_GRAPHICS.equalsIgnoreCase(scheme))
            ...
            return MilStd2525PointGraphicRetriever.composeFilenameEms(code);
     ...
     */
    protected static String composeFilenameTacticalGraphic(SymbolCode code, String dir) {
        String scheme = code.getScheme();
     ...
     * @return The filename of the icon for the specified graphic.
     */
    protected static String composeFilenameMetoc(SymbolCode code) {
        String scheme = code.getScheme();
        String category = code.getCategory();
     ...
     * @return The filename of the icon for the specified graphic.
     */
    protected static String composeFilenameEms(SymbolCode code) {
        String scheme = code.getScheme();
        String category = code.getCategory();
        String functionId = code.getFunctionId();
