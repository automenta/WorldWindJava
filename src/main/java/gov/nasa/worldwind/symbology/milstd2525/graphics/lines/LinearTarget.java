...
public class LinearTarget extends AbstractMilStd2525TacticalGraphic {
    ...
    protected void createShapes(DrawContext dc) {
        ...
        List<Position> positions = LinearTarget.computeVerticalSegmentPositions(globe, pA, vBA, verticalLength);
        this.paths[1] = createPath(positions);

        // Compute the right vertical segment
        positions = LinearTarget.computeVerticalSegmentPositions(globe, pB, vBA, verticalLength);
    ...
    protected void createLabels() {
        ...
        if (!WWUtil.isEmpty(text)) {
            ...
            label.setOffset(LinearTarget.getBottomLabelOffset());
        }
    }
    ...
    protected void determineLabelPositions(DrawContext dc) {
        ...
        List<Position> positions = LinearTarget.computeVerticalSegmentPositions(globe, pMid, vAB, offset);
        List<Position> orientationPositions = LinearTarget.computeVerticalSegmentPositions(globe, pB, vAB, offset);
