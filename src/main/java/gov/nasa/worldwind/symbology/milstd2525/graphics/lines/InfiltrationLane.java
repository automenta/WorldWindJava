...
public class InfiltrationLane extends AbstractMilStd2525TacticalGraphic {
    ...
    protected void createShapes(DrawContext dc) {
        ...
        Vec4[] controlPoints = InfiltrationLane.computeBezierControlPoints(dc, pt1, pt2, InfiltrationLane.getNumControlPoints(),
            this.getCurvature());
        ...
        Vec4 offsetPt = InfiltrationLane.bezierNearestPointToSegment(projectedPt3, pt3, controlPoints, coefficients, 0.01);
