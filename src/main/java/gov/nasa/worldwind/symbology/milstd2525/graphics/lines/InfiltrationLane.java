...
public class InfiltrationLane extends AbstractMilStd2525TacticalGraphic {
     ...
     */
    protected int intervals = InfiltrationLane.DEFAULT_NUM_INTERVALS;
    /**
     * Factor that controls the curve of the line. Valid values are 0 to 1. Larger values result in a more pronounced
     * curve.
     */
    protected double curvature = InfiltrationLane.DEFAULT_CURVATURE;
     ...
     */
    protected static int getNumControlPoints() {
        return InfiltrationLane.NUM_CONTROL_POINTS;
    }
     ...
     */
    protected static Vec4 bezierNearestPointToSegment(Vec4 p0, Vec4 p1, Vec4[] controlPoints, int[] coefficients,
        double tolerance) {
        double dist1;
        double dist2;
     ...
     */
    protected static Vec4[] computeBezierControlPoints(DrawContext dc, Vec4 start, Vec4 end, int numControlPoints,
        double curvature) {
    ...
    protected void createShapes(DrawContext dc) {
        ...
        Vec4[] controlPoints = InfiltrationLane.computeBezierControlPoints(dc, pt1, pt2,
            InfiltrationLane.getNumControlPoints(),
            this.getCurvature());
        ...
        Vec4 offsetPt = InfiltrationLane.bezierNearestPointToSegment(projectedPt3, pt3, controlPoints, coefficients,
            0.01);
