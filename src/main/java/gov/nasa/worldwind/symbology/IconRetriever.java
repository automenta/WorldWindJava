 ...
 * implemented for a specific symbol set. For example, the {@link MilStd2525IconRetriever} retrieves icons for symbols
 * in the MIL-STD-2525 symbology set. See the <a href="https://worldwind.arc.nasa.gov/java/tutorials/icon-retriever/"
