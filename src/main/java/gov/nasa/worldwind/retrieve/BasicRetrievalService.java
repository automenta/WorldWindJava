    ...
    implements RetrievalService, Thread.UncaughtExceptionHandler
{
    ...
    private final ConcurrentLinkedQueue<RetrievalTask> activeTasks; // tasks currently allocated a thread
        ...
        implements RetrievalFuture, Comparable<RetrievalTask>
    {
        ...
        private final double priority; // retrieval secondary priority (primary priority is submit time)
