...
public class Cylinder implements Extent, Renderable {
     ...
     * @see #computeVerticalBoundingCylinder(Globe, double, Sector)
     */
    ...
    protected static Cylinder computeVerticalBoundsFromSectorLatitudeRange(Globe globe, Sector sector, double minHeight,
        ...
        // with maxHeight.
        Vec4 extremePoint = globe.computePointFromPosition(sector.latMin(), sector.lonMin(),
            maxHeight);
        ...
        // with maxHeight.
        extremePoint = globe.computePointFromPosition(sector.latMax(), sector.lonMax(), maxHeight);
    ...
    protected static Cylinder computeVerticalBoundsFromSectorQuadrilateral(Globe globe, Sector sector, double minHeight,
        ...
        Vec4 extremePoint = globe.computePointFromPosition(sector.latMin(), sector.lonMin(),
            minHeight);
        double minProj = extremePoint.subtract3(centerPoint).dot3(axis);
        extremePoint = globe.computePointFromPosition(sector.latMax(), sector.lonMax(), minHeight);
    ...
    protected static Cylinder computeVerticalBoundsFromSectorVertices(Globe globe, Sector sector, double minHeight,
        ...
        Vec4 southwest = globe.computePointFromPosition(sector.latMin(), sector.lonMin(), minHeight);
        Vec4 southeast = globe.computePointFromPosition(sector.latMin(), sector.lonMax(), minHeight);
        Vec4 northeast = globe.computePointFromPosition(sector.latMax(), sector.lonMax(), minHeight);
        Vec4 northwest = globe.computePointFromPosition(sector.latMax(), sector.lonMin(), minHeight);
    ...
    public void render(DrawContext dc) {
        ...
        try {
            ...
            gl.glColor4f(1.00f, 1.00f, 1.00f, 0.4f);
            ...
            gl.glColor4f(1.00f, 0.00f, 1.00f, 0.4f);
            gl.glBegin(GL2.GL_LINES);
            gl.glVertex3d(this.bottomCenter.x, this.bottomCenter.y, this.bottomCenter.z);
            gl.glVertex3d(this.topCenter.x, this.topCenter.y, this.topCenter.z);
            gl.glEnd();
            ...
            gl.glColor4f(1.00f, 1.00f, 1.00f, 0.5f);
