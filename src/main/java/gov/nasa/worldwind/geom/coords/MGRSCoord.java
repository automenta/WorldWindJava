...
public class MGRSCoord {
     ...
     * </p>
     * <p>Valid examples:<br>
     * 32TLP5626635418<br> 32 T LP 56266 35418<br> 11S KU 528 111<br>
     * </p>
     *
    ...
    public static MGRSCoord fromString(String MGRSString, Globe globe) {
        ...
        return new MGRSCoord(Angle.fromRadians(converter.getLatitude()), Angle.fromRadians(converter.getLongitude()),
            MGRSString);
    }
