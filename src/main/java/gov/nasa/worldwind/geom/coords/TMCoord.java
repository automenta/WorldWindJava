...
public class TMCoord {
     ...
     * @param a               semi-major ellipsoid radius. If this and argument f are non-null and globe is null, will
     *                        use the specfied a and f.
     * @param f               ellipsoid flattening. If this and argument a are non-null and globe is null, will use the
     *                        specfied a and f.
     * @param originLatitude  the origin latitude <code>Angle</code>.
     * @param centralMeridian the central meridian longitude <code>Angle</code>.
     * @param falseEasting    easting value at the center of the projection in meters.
     ...
     *                                  TM coordinates fails. If the globe is null conversion will default to using
     *                                  WGS84.
     */
     ...
     *                                  conversion to geodetic coordinates fails. If the globe is null conversion will
     *                                  default to using WGS84.
     */
