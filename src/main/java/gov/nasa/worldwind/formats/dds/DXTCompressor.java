...
public interface DXTCompressor {
     ...
     */
    int getCompressedSize(BufferedImage image, DXTCompressionAttributes attributes);
     ...
     * @see #getCompressedSize(BufferedImage, DXTCompressionAttributes)
     */
    void compressImage(BufferedImage image, DXTCompressionAttributes attributes,
        ByteBuffer buffer);
}
