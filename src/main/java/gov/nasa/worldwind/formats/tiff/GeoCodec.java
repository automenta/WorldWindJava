...
class GeoCodec {
    ...
    public void setModelTransformation(Matrix matrix) {
        ...
        Matrix tp = this.modelTransform.multiply(Matrix.fromTranslation(0.0d, 0.0d, 0.0d));
        this.addModelTiePoint(0.0d, 0.0d, 0.0d, tp.m14, tp.m24, tp.m34);

        // Now, since ModelTiePoints (33922) & ModelPixelScale(3355) always go together
        // let's set ModelPixelScale values

        this.setModelPixelScale(matrix.m11, matrix.m22, 0.0d);
    }
