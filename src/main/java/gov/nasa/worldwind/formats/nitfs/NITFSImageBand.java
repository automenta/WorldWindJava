...
class NITFSImageBand {
    ...
    private final String significanceForImageCategory;
    private final String imageFilterCondition;
    private final String stdImageFilterCode;
    private final short numOfLookupTables;
