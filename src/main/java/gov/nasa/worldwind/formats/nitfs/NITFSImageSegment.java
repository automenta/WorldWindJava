...
public class NITFSImageSegment extends NITFSSegment {
    ...
    private void parseRPFMaskSubsection(ByteBuffer buffer) throws NITFSRuntimeException {
        ...
        this.hasTransparentPixels = (0 < this.transparencySequenceRecordLength
            || 0 < this.transparentOutputPixelCodeLength);
    }

    private void parseImageData(ByteBuffer buffer) throws NITFSRuntimeException {
    ...
    private void parseRPFSpatialDataSubsection(ByteBuffer buffer) throws NITFSRuntimeException {

    }

    private void parseRPFCompressionLookupSubsection(ByteBuffer buffer)
    ...
    private void parseRPFCompressionSectionSubheader(ByteBuffer buffer) throws NITFSRuntimeException {
    ...
    private void parseImageDisplayParametersSubheader(ByteBuffer buffer) throws NITFSRuntimeException {
    ...
    private void parseImageSubheaders(ByteBuffer buffer) throws NITFSRuntimeException {
    ...
    private void parseImageLocation(ByteBuffer buffer) throws NITFSRuntimeException {
    ...
    private void parseImageTableStructure(ByteBuffer buffer) throws NITFSRuntimeException {
    ...
    private void parseImageBands(ByteBuffer buffer) throws NITFSRuntimeException {
        if (0 == this.NBANDS)
    ...
    private void parseImageCompressionStructure(ByteBuffer buffer) {
    ...
    private void parseCommentRecords(ByteBuffer buffer) {
    ...
    private void parseImageGeographicLocation(ByteBuffer buffer) {
        // [ nitf image geographic location ]
    ...
    private void parseIdentificationSecurityStructureFields(ByteBuffer buffer)
        throws NITFSRuntimeException {
        // [ nitf identification , security, structure fields]
