...
public class DBaseFile extends AVListImpl {
     ...
     *
     * @param buffer    the DBaseField sequence {@link ByteBuffer} to read from.
    ...
    /**
     * Reads a {@link DBaseRecord} instance from the given {@link ByteBuffer};
     * <p>
     ...
     *
     * @param buffer       the DBase record {@link ByteBuffer} to read from.
