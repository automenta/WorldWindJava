...
public class RPFColorMap {
    ...
    public RPFColorMap(ByteBuffer buffer, int colormapSubsectionOffset) {
    ...
    private void parseRPFColorOffsetRecord(ByteBuffer buffer) {
    ...
    private void loadColorMaps(ByteBuffer buffer, int colormapSubsectionOffset) {
    ...
    private void loadHistogram(ByteBuffer buffer, int colormapSubsectionOffset) {
        if (0 == this.numOfColorRecords)
            throw new NITFSRuntimeException("NITFSReader.InvalidNumberOfColorRecords");
