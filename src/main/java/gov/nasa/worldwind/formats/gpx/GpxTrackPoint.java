...
public class GpxTrackPoint extends ElementParser implements TrackPoint {
    ...
    public GpxTrackPoint(String uri, String lname, String qname, Attributes attributes) {
        this("trkpt", uri, lname, qname, attributes);
    }

    @SuppressWarnings("UnusedDeclaration")
    protected GpxTrackPoint(String pointType, String uri, String lname, String qname,
