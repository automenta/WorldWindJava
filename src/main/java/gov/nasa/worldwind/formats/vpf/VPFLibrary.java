...
public class VPFLibrary extends AVListImpl {
    ...
    protected static double[] parseEllipsoidDetail(CharSequence value) {
        if (WWUtil.isEmpty(value))
            return null;
    ...
    public void addAllCoverages(Iterable<? extends VPFCoverage> collection) {
        if (collection == null) {
    ...
    public Angle computeArcLengthFromMapDistance(double millimeters) {
        ...
        double meters = this.getMapScale() * millimeters / 1000.0d;
