...
public class ShapeEditor implements SelectListener, PropertyChangeListener {
    ...
    protected void dragWholeShape(DragSelectEvent dragEvent) {
        ...
        if (inters != null) {
            ...
            dragObject.moveTo(getWwd().model().getGlobe(), new Position(p,
    ...
    protected void updateShapeAnnotation() {
        ...
        if (center != null) {
            ControlPointMarker dummyMarker = ShapeEditor.makeControlPoint(new Position(center, 0),
                new BasicMarkerAttributes(),
                0, ShapeEditor.ANNOTATION);
    ...
    protected Vec4 computeControlPointDelta(LatLon previousLocation, LatLon currentLocation) {
        ...
        Vec4 terrainPoint = getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(currentLocation);
        Vec4 previousPoint = getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(previousLocation);
    ...
    protected Position computeEdgeLocation(LatLon center, LatLon location, double length) {
        Vec4 centerPoint = getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(center);
        Vec4 surfaceNormal = getWwd().model().getGlobe().computeEllipsoidalNormalAtLocation(
            center.getLatitude(), center.getLongitude());

        Vec4 point1 = getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(location);
        ...
        LatLon edgeLocation = getWwd().model().getGlobe().computePositionFromEllipsoidalPoint(
    ...
    protected Position computeRectangularEdgeLocation(LatLon begin, LatLon end, double width) {
        ...
        Angle edgeLength = Angle.fromRadians(width / this.getWwd().model().getGlobe().getRadius());
    ...
    protected void moveLocation(ControlPointMarker controlPoint, Position terrainPosition, List<LatLon> locations) {
        ...
        Vec4 markerPoint = getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
            new Position(controlPoint.getPosition(), 0));
        Position markerPosition = getWwd().model().getGlobe().computePositionFromEllipsoidalPoint(
    ...
    protected void updatePolygonAirspaceControlPoints() {
        ...
        if (markers == null) {
            ...
            for (LatLon location : locations) {
                ...
                controlPoints.add(
                    ShapeEditor.makeControlPoint(cpPosition, this.getLocationControlPointAttributes(), i++,
            ...
            controlPoints.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getAngleControlPointAttributes(), i, ShapeEditor.ROTATION));
    ...
    protected void reshapeCappedCylinder(Position terrainPosition, ControlPointMarker controlPoint) {
        ...
        Vec4 centerPoint = getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(cylinder.getCenter());
        Vec4 markerPoint = getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
    ...
    protected void updateCappedCylinderControlPoints() {
        ...
        if (markers == null) {
            ...
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getSizeControlPointAttributes(), 0,
                    ShapeEditor.OUTER_RADIUS));
            if (hasInnerRadius) {
                cpPosition = new Position(innerRadiusLocation, innerRadiusAltitude);
                markerList.add(
                    ShapeEditor.makeControlPoint(cpPosition, this.getSizeControlPointAttributes(), 1,
    ...
    protected void updatePartialCappedCylinderControlPoints() {
        ...
        LatLon leftAzimuthLocation = LatLon.greatCircleEndPosition(cylinder.getCenter(), azimuths[0],
            Angle.fromRadians(averageRadius / this.getWwd().model().getGlobe().getEquatorialRadius()));
        ...
        LatLon rotationControlLocation = LatLon.greatCircleEndPosition(cylinder.getCenter(), this.getCurrentHeading(),
            Angle.fromRadians(1.2 * radii[1] / this.getWwd().model().getGlobe().getEquatorialRadius()));
        double rotationControlAltitude = this.getControlPointAltitude(rotationControlLocation);
        ...
        if (markers == null) {
            ...
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getAngleControlPointAttributes(), 2,
                    ShapeEditor.LEFT_AZIMUTH));
            cpPosition = new Position(rightAzimuthLocation, rightAzimuthAltitude);
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getAngleControlPointAttributes(), 3,
                    ShapeEditor.RIGHT_AZIMUTH));

            cpPosition = new Position(rotationControlLocation, rotationControlAltitude);
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getAngleControlPointAttributes(), 4, ShapeEditor.ROTATION));
    ...
    protected void updateCappedEllipticalCylinderControlPoints() {
        ...
        LatLon rotationControlLocation = LatLon.greatCircleEndPosition(cylinder.getCenter(), this.getCurrentHeading(),
            Angle.fromRadians(1.4 * radii[3] / this.getWwd().model().getGlobe().getEquatorialRadius()));
        double rotationControlAltitude = this.getControlPointAltitude(rotationControlLocation);
        ...
        if (markers == null) {
            ...
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getSizeControlPointAttributes(), 2,
                    ShapeEditor.OUTER_MINOR_RADIUS));
            cpPosition = new Position(outerMajorRadiusLocation, outerMajorRadiusAltitude);
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getSizeControlPointAttributes(), 3,
    ...
    protected void reshapeSphere(Position terrainPosition, ControlPointMarker controlPoint) {
        ...
        Vec4 centerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
            sphere.getLocation());
        Vec4 markerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
            controlPoint.getPosition());
        Vec4 vMarker = markerPoint.subtract3(centerPoint).normalize3();
    ...
    protected void reshapeOrbit(Position terrainPosition, ControlPointMarker controlPoint) {
        ...
        Vec4 centerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(center);
        ...
        {
            Vec4 delta = this.computeControlPointDelta(this.getPreviousPosition(), terrainPosition);
            Position markerPosition = this.getWwd().model().getGlobe().computePositionFromEllipsoidalPoint(
                markerPoint.add3(delta));
    ...
    protected void updateOrbitControlPoints() {
        ...
        if (markers == null) {
            ...
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getLocationControlPointAttributes(), 0,
                    ShapeEditor.LOCATION));
            cpPosition = new Position(locations[1], location1Altitude);
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getLocationControlPointAttributes(), 1,
                    ShapeEditor.LOCATION));
            ...
            cpPosition = new Position(rotationControlLocation, rotationControlAltitude);
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getAngleControlPointAttributes(), 3, ShapeEditor.ROTATION));
    ...
    protected void reshapeRoute(Position terrainPosition, ControlPointMarker controlPoint) {
        ...
        if (controlPoint != null && controlPoint.getPurpose().equals(ShapeEditor.ROTATION)) {
            ...
            Vec4 centerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(legCenter);
            Vec4 markerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
                new Position(controlPoint.getPosition(), 0));
            Vec4 vMarker = markerPoint.subtract3(centerPoint).normalize3();
            Vec4 delta = this.computeControlPointDelta(this.getPreviousPosition(), terrainPosition);
    ...
    protected void updateRouteControlPoints() {
        ...
        if (markers == null) {
            ...
            for (LatLon cpPosition : locations) {
                ...
                controlPoints.add(
                    ShapeEditor.makeControlPoint(position, this.getLocationControlPointAttributes(), i++,
                        ShapeEditor.LOCATION));
            }

            Position position = new Position(leftWidthPosition, leftWidthPosition.getAltitude());
            controlPoints.add(
                ShapeEditor.makeControlPoint(position, this.getSizeControlPointAttributes(), i++,
                    ShapeEditor.RIGHT_WIDTH));
            ...
            controlPoints.add(
                ShapeEditor.makeControlPoint(position, this.getAngleControlPointAttributes(), i, ShapeEditor.ROTATION));
    ...
    protected void updateTrackControlPoints() {
        ...
        for (int i = 0; i < legs.size(); i++) {
            ...
            if (markers == null) {
                ...
                controlPoints.add(
                    ShapeEditor.makeControlPoint(cpPosition, this.getSizeControlPointAttributes(), 2, i,
                        ShapeEditor.LEFT_WIDTH));
                cpPosition = new Position(cwRPosition, cwRPosition.getAltitude());
                controlPoints.add(
                    ShapeEditor.makeControlPoint(cpPosition, this.getSizeControlPointAttributes(), 3, i,
                        ShapeEditor.RIGHT_WIDTH));
            } else {
    ...
    protected void reshapeSurfaceCircle(Position terrainPosition, Marker controlPoint) {
        ...
        Vec4 centerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(circle.getCenter());
        Vec4 markerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
            controlPoint.getPosition());
        Vec4 vMarker = markerPoint.subtract3(centerPoint).normalize3();
    ...
    protected void reshapeSurfaceSquare(Position terrainPosition, ControlPointMarker controlPoint) {
        ...
        Vec4 terrainPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(terrainPosition);
        Vec4 previousPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
            this.getPreviousPosition());
        Vec4 delta = terrainPoint.subtract3(previousPoint);

        Vec4 centerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(square.getCenter());
        Vec4 markerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
            controlPoint.getPosition());
    ...
    protected void updateSurfaceSquareControlPoints() {
        ...
        if (markers == null) {
            ...
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getAngleControlPointAttributes(), 1, ShapeEditor.ROTATION));
    ...
    protected void reshapeSurfaceQuad(Position terrainPosition, ControlPointMarker controlPoint) {
        ...
        Vec4 centerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(quad.getCenter());
        Vec4 markerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
            controlPoint.getPosition());
        Vec4 vMarker = markerPoint.subtract3(centerPoint).normalize3();
    ...
    protected void updateSurfaceQuadControlPoints() {
        ...
        if (markers == null) {
            ...
            markerList.add(ShapeEditor.makeControlPoint(cpPosition, this.getSizeControlPointAttributes(), 0,
                ShapeEditor.WIDTH));
            cpPosition = new Position(heightLocation, 0);
            markerList.add(ShapeEditor.makeControlPoint(cpPosition, this.getSizeControlPointAttributes(), 1,
                ShapeEditor.HEIGHT));

            cpPosition = new Position(rotationLocation, 0);
            markerList.add(
                ShapeEditor.makeControlPoint(cpPosition, this.getAngleControlPointAttributes(), 2, ShapeEditor.ROTATION));
    ...
    protected void reshapeSurfaceEllipse(Position terrainPosition, ControlPointMarker controlPoint) {
        ...
        Vec4 centerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(ellipse.getCenter());
        Vec4 markerPoint = this.getWwd().model().getGlobe().computeEllipsoidalPointFromLocation(
            controlPoint.getPosition());
        Vec4 vMarker = markerPoint.subtract3(centerPoint).normalize3();
