...
public class DataConfigurationFilter implements FileFilter, FileStoreFilter {
    ...
    /**
     * Returns true if the specified {@link InputStream} can be opened as an XML document, and calling {@link
     * #accept(Document)} returns true.
     *
    ...
    /**
     * Returns true if the specified DOM {@link Element} should be accepted as a configuration document.
     *
