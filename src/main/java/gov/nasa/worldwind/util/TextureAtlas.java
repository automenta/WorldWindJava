 ...
 * document describes this technique: <a target="blank_" href="ftp://download.nvidia.com/developer/NVTextureSuite/Atlas_Tools/Texture_Atlas_Whitepaper.pdf">Improve
...
public class TextureAtlas {
     ...
     */
    @SuppressWarnings("UnusedParameters")
    protected void endMoveEntries(BufferedImage oldBackingImage, RenderedImage newBackingImage) {
        if (this.g != null) // This should never happen, but we check anyway.
        {
            this.g.dispose();
            this.g = null;
