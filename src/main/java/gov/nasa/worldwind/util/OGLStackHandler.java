...
public class OGLStackHandler {
    ...
    public void pushModelview(GLMatrixFunc gl) {
        gl.glMatrixMode(GL2.GL_MODELVIEW);
        gl.glPushMatrix();
        this.modelviewPushed = true;
    }

    public void pushProjection(GLMatrixFunc gl) {
        gl.glMatrixMode(GL2.GL_PROJECTION);
        gl.glPushMatrix();
        this.projectionPushed = true;
    }

    public void pushTexture(GLMatrixFunc gl) {
    ...
    public void pushModelviewIdentity(GLMatrixFunc gl) {
        gl.glMatrixMode(GL2.GL_MODELVIEW);
        this.modelviewPushed = true;
        gl.glPushMatrix();
        gl.glLoadIdentity();
    ...
    public void pushProjectionIdentity(GLMatrixFunc gl) {
        gl.glMatrixMode(GL2.GL_PROJECTION);
        this.projectionPushed = true;
        gl.glPushMatrix();
        gl.glLoadIdentity();
    ...
    public void pushTextureIdentity(GLMatrixFunc gl) {
        gl.glMatrixMode(GL2.GL_TEXTURE);
        this.texturePushed = true;
        gl.glPushMatrix();
        gl.glLoadIdentity();
