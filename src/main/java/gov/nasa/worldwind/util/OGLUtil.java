...
public class OGLUtil {
    ...
    /**
     * Sets the GL color state to the specified {@link Color}, and with the specified color mode. If
    ...
    public static int computeTexturePixelFormat(int internalFormat) {
        ...
        return switch (internalFormat) {
            case GL2.GL_ALPHA, GL2.GL_ALPHA4, GL2.GL_ALPHA8, GL2.GL_ALPHA12, GL2.GL_ALPHA16, GL2.GL_COMPRESSED_ALPHA -> GL2.GL_ALPHA;
            case GL2.GL_COMPRESSED_LUMINANCE, GL2.GL_LUMINANCE, GL2.GL_LUMINANCE4, GL2.GL_LUMINANCE8, GL2.GL_LUMINANCE12, GL2.GL_LUMINANCE16, GL2.GL_SLUMINANCE, GL2.GL_SLUMINANCE8 -> GL2.GL_LUMINANCE;
            case GL2.GL_COMPRESSED_LUMINANCE_ALPHA, GL2.GL_LUMINANCE_ALPHA, GL2.GL_LUMINANCE4_ALPHA4, GL2.GL_LUMINANCE6_ALPHA2, GL2.GL_LUMINANCE8_ALPHA8, GL2.GL_LUMINANCE12_ALPHA4, GL2.GL_LUMINANCE12_ALPHA12, GL2.GL_LUMINANCE16_ALPHA16, GL2.GL_SLUMINANCE_ALPHA, GL2.GL_SLUMINANCE8_ALPHA8 -> GL2.GL_LUMINANCE_ALPHA;
            case GL2.GL_COMPRESSED_INTENSITY, GL2.GL_DEPTH_COMPONENT, GL2.GL_DEPTH_COMPONENT16, GL2.GL_DEPTH_COMPONENT24, GL2.GL_DEPTH_COMPONENT32, GL2.GL_INTENSITY, GL2.GL_INTENSITY4, GL2.GL_INTENSITY8, GL2.GL_INTENSITY12, GL2.GL_INTENSITY16 -> GL2.GL_RED;
            case GL2.GL_COMPRESSED_RGB, GL2.GL_R3_G3_B2, GL2.GL_RGB, GL2.GL_RGB4, GL2.GL_RGB5, GL2.GL_RGB8, GL2.GL_RGB10, GL2.GL_RGB12, GL2.GL_RGB16, GL2.GL_SRGB, GL2.GL_SRGB8 -> GL2.GL_RGB;
            case GL2.GL_COMPRESSED_RGBA, GL2.GL_RGBA, GL2.GL_RGBA2, GL2.GL_RGBA4, GL2.GL_RGB5_A1, GL2.GL_RGBA8, GL2.GL_RGB10_A2, GL2.GL_RGBA12, GL2.GL_RGBA16, GL2.GL_SRGB_ALPHA, GL2.GL_SRGB8_ALPHA8 -> GL2.GL_RGBA;
            default -> 0;
        };
    }
    ...
    public static int estimateTextureMemorySize(int internalFormat, int width, int height, boolean includeMipmaps) {
        ...
        return switch (internalFormat) {
            case GL2.GL_ALPHA4, GL2.GL_LUMINANCE4, GL2.GL_INTENSITY4 -> numPixels / 2;
            case GL2.GL_ALPHA, GL2.GL_ALPHA8, GL2.GL_LUMINANCE, GL2.GL_LUMINANCE8, GL2.GL_LUMINANCE4_ALPHA4, GL2.GL_LUMINANCE6_ALPHA2, GL2.GL_INTENSITY, GL2.GL_INTENSITY8, GL2.GL_R3_G3_B2, GL2.GL_RGBA2, GL2.GL_SLUMINANCE, GL2.GL_SLUMINANCE8 -> numPixels;
            case GL2.GL_ALPHA12, GL2.GL_LUMINANCE12, GL2.GL_INTENSITY12, GL2.GL_RGB4 -> 12 * numPixels / 8;
// Assume the driver allocates 16 bits per pixel for GL_RGB5.
            case GL2.GL_ALPHA16, GL2.GL_DEPTH_COMPONENT16, GL2.GL_LUMINANCE16, GL2.GL_LUMINANCE_ALPHA, GL2.GL_LUMINANCE8_ALPHA8, GL2.GL_LUMINANCE12_ALPHA4, GL2.GL_INTENSITY16, GL2.GL_RGB5, GL2.GL_RGBA4, GL2.GL_RGB5_A1, GL2.GL_SLUMINANCE_ALPHA, GL2.GL_SLUMINANCE8_ALPHA8 ->
                2 * numPixels;
            case GL2.GL_DEPTH_COMPONENT, GL2.GL_DEPTH_COMPONENT24, GL2.GL_LUMINANCE12_ALPHA12, GL2.GL_RGB, GL2.GL_RGB8, GL2.GL_SRGB, GL2.GL_SRGB8 ->
                3 * numPixels;
// Assume the driver allocates 32 bits per pixel for GL_RGB10.
            case GL2.GL_DEPTH_COMPONENT32, GL2.GL_LUMINANCE16_ALPHA16, GL2.GL_RGB10, GL2.GL_RGBA, GL2.GL_RGBA8, GL2.GL_RGB10_A2, GL2.GL_SRGB_ALPHA, GL2.GL_SRGB8_ALPHA8 ->
                4 * numPixels;
            case GL2.GL_RGB12 -> 36 * numPixels / 8;
            case GL2.GL_RGB16, GL2.GL_RGBA12 -> 6 * numPixels;
            case GL2.GL_RGBA16 -> 8 * numPixels;
            default -> 0;
        };
    }
     ...
     */
    public static TextureData newTextureData(URL url, boolean useMipMaps, GLProfile glp) throws IOException {
