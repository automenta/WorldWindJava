 ...
 * unknown, but all fields can be accessed via the inherited {@link AbstractXMLEventParser#getField(javax.xml.namespace.QName)}
 * and {@link AbstractXMLEventParser#getFields()}.
 *
 * @author tag
