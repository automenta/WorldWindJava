...
public class EntityMap {
    ...
    protected static final String[] entityKeys = {
        "&#x1fbf;",
        "&#x1ffe;",
        "&#x2d8;",
        "&#x2db;",
    ...
    static {
        EntityMap.patterns.add(Pattern.compile("&[^;]+;")); // ampersand followed by any number of chars followed by semicolon
    }

    static {
        for (int i = 0; i < EntityMap.entityKeys.length; i++) {
            EntityMap.map.put(EntityMap.entityKeys[i], EntityMap.entityReplacements[i]);
        }
    }
...
// http://www.whatwg.org/specs/web-apps/current-work/multipage/named-character-references.html#named-character-references
    ...
    public static String replaceAll(String source) {
        int regionStart = 0;
        for (String entity = EntityMap.getNextEntity(source, regionStart); entity != null;
            entity = EntityMap.getNextEntity(source, regionStart)) {
    ...
    protected static String getNextEntity(CharSequence source, int regionStart) {
        ...
        for (Pattern pattern : EntityMap.patterns) {
