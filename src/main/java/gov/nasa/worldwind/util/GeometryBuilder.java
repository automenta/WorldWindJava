...
public class GeometryBuilder {
    ...
    //********************  Sphere  ********************************//
    //**************************************************************//
    private static final float[] icosahedronVertexArray =
        {
            -GeometryBuilder.X, 0, GeometryBuilder.Z,
            GeometryBuilder.X, 0, GeometryBuilder.Z,
            -GeometryBuilder.X, 0, -GeometryBuilder.Z,
            GeometryBuilder.X, 0, -GeometryBuilder.Z,
            0, GeometryBuilder.Z, GeometryBuilder.X,
            0, GeometryBuilder.Z, -GeometryBuilder.X,
            0, -GeometryBuilder.Z, GeometryBuilder.X,
            0, -GeometryBuilder.Z, -GeometryBuilder.X,
            GeometryBuilder.Z, GeometryBuilder.X, 0,
            -GeometryBuilder.Z, GeometryBuilder.X, 0,
            GeometryBuilder.Z, -GeometryBuilder.X, 0,
            -GeometryBuilder.Z, -GeometryBuilder.X, 0
        };
    private static final int[] icosahedronIndexArray =
        {
            1, 4, 0,
            4, 9, 0,
            4, 5, 9,
    ...
    private static final float[] boxVertexArray =
        {    // right
            GeometryBuilder.B, -GeometryBuilder.B, GeometryBuilder.B,          // 0
            GeometryBuilder.B, GeometryBuilder.B, GeometryBuilder.B,           // 1
            GeometryBuilder.B, -GeometryBuilder.B, -GeometryBuilder.B,         // 2
            GeometryBuilder.B, GeometryBuilder.B, -GeometryBuilder.B,          // 3

            // front
            -GeometryBuilder.B, GeometryBuilder.B, GeometryBuilder.B,          // 4
            GeometryBuilder.B, GeometryBuilder.B, GeometryBuilder.B,           // 5
            -GeometryBuilder.B, -GeometryBuilder.B, GeometryBuilder.B,         // 6
            GeometryBuilder.B, -GeometryBuilder.B, GeometryBuilder.B,          // 7

            // left
            -GeometryBuilder.B, GeometryBuilder.B, GeometryBuilder.B,          // 8
            -GeometryBuilder.B, -GeometryBuilder.B, GeometryBuilder.B,         // 9
            -GeometryBuilder.B, GeometryBuilder.B, -GeometryBuilder.B,         // 10
            -GeometryBuilder.B, -GeometryBuilder.B, -GeometryBuilder.B,        // 11

            // back
            GeometryBuilder.B, GeometryBuilder.B, -GeometryBuilder.B,          // 12
            -GeometryBuilder.B, GeometryBuilder.B, -GeometryBuilder.B,         // 13
            GeometryBuilder.B, -GeometryBuilder.B, -GeometryBuilder.B,         // 14
            -GeometryBuilder.B, -GeometryBuilder.B, -GeometryBuilder.B,        // 15

            // top
            GeometryBuilder.B, GeometryBuilder.B, GeometryBuilder.B,           // 16
            -GeometryBuilder.B, GeometryBuilder.B, GeometryBuilder.B,          // 17
            GeometryBuilder.B, GeometryBuilder.B, -GeometryBuilder.B,          // 18
            -GeometryBuilder.B, GeometryBuilder.B, -GeometryBuilder.B,         // 19

            // bottom
            -GeometryBuilder.B, -GeometryBuilder.B, GeometryBuilder.B,          // 20
            GeometryBuilder.B, -GeometryBuilder.B, GeometryBuilder.B,           // 21
            -GeometryBuilder.B, -GeometryBuilder.B, -GeometryBuilder.B,         // 22
            GeometryBuilder.B, -GeometryBuilder.B, -GeometryBuilder.B           // 23
        };
    ...
    private static final float[] pyramidVertexArray =
        {    // right
            0, 0, GeometryBuilder.P,           // 0   (point)
            GeometryBuilder.P, -GeometryBuilder.P, -GeometryBuilder.P,         // 1
            GeometryBuilder.P, GeometryBuilder.P, -GeometryBuilder.P,          // 2

            // front
            0, 0, GeometryBuilder.P,           // 3   (point)
            -GeometryBuilder.P, -GeometryBuilder.P, -GeometryBuilder.P,         // 4
            GeometryBuilder.P, -GeometryBuilder.P, -GeometryBuilder.P,          // 5

            // left
            0, 0, GeometryBuilder.P,           // 6   (point)
            -GeometryBuilder.P, GeometryBuilder.P, -GeometryBuilder.P,         // 7
            -GeometryBuilder.P, -GeometryBuilder.P, -GeometryBuilder.P,        // 8

            // back
            0, 0, GeometryBuilder.P,           // 9   (point)
            GeometryBuilder.P, GeometryBuilder.P, -GeometryBuilder.P,         // 10
            -GeometryBuilder.P, GeometryBuilder.P, -GeometryBuilder.P,        // 11

            // bottom (base) face
            GeometryBuilder.P, GeometryBuilder.P, -GeometryBuilder.P,          // 12
            -GeometryBuilder.P, GeometryBuilder.P, -GeometryBuilder.P,         // 13
            GeometryBuilder.P, -GeometryBuilder.P, -GeometryBuilder.P,         // 14
            -GeometryBuilder.P, -GeometryBuilder.P, -GeometryBuilder.P         // 15
        };
    private static final int[] pyramidIndexArray =
        {
            0, 1, 2,              // right
            3, 4, 5,              // front
            6, 7, 8,              // left
    ...
    private static final int[] pyramidFacesIndexArray =
        {
            0, 1, 2,              // right
            0, 1, 2,              // front
            0, 1, 2,              // left
    ...
    private int orientation = GeometryBuilder.OUTSIDE;
    ...
    public static void makeCylinderVertices(Terrain terrain, LatLon center, double radius, double[] altitudes,
    ...
    public static void makeCylinderVertices(Terrain terrain, LatLon center, double minorRadius, double majorRadius,
        ...
        for (int i = 0; i < slices; i++) {
            double angle = (i == slices - 1) ? 0 : i * da;
    ...
    public static void makeCylinderVertices(float radius, float height, int slices, int stacks, float[] dest) {
        int numPoints = GeometryBuilder.getCylinderVertexCount(slices, stacks);
        int numCoords = 3 * numPoints;
    ...
    public static void makeCylinderOutlineIndices(int slices, int stacks, int[] dest) {
        ...
        for (i = 0; i < slices; i++) {
            vertex = i * (stacks + 1);
            dest[index++] = vertex;
            dest[index++] = (i == slices - 1) ? 0 : vertex + stacks + 1;
        }
        // Top ring
        for (i = 0; i < slices; i++) {
            vertex = i * (stacks + 1) + stacks;
            dest[index++] = vertex;
            dest[index++] = (i == slices - 1) ? stacks : vertex + stacks + 1;
        }
    }
    ...
    public static void makePartialCylinderVertices(Terrain terrain, LatLon center, double radius, double[] altitudes,
    ...
    public static void makePartialCylinderVertices(float radius, float height, int slices, int stacks,
    ...
    public static void makePartialCylinderOutlineIndices(int slices, int stacks, int[] dest) {
    ...
    public static void makeDiskVertices(Terrain terrain, LatLon center, double innerRadius, double outerRadius,
    ...
    public static void makeDiskVertices(Terrain terrain, LatLon center, double[] radii, Angle heading,
        double altitude, boolean terrainConformant, int slices, int loops, Vec4 refPoint, float[] dest) {
        int numPoints = GeometryBuilder.getDiskVertexCount(slices, loops);
        int numCoords = 3 * numPoints;
    ...
    public static void makeDiskVertices(float innerRadius, float outerRadius, int slices, int loops, float[] dest) {
        int numPoints = GeometryBuilder.getDiskVertexCount(slices, loops);
        int numCoords = 3 * numPoints;
    ...
    public static LatLon[] makePartialDiskLocations(Extent globe, LatLon center, double innerRadius, double outerRadius,
    ...
    public static void makePartialDiskVertices(Terrain terrain, LatLon center, double innerRadius, double outerRadius,
    ...
    public static void makePartialDiskVertices(float innerRadius, float outerRadius, int slices, int loops,
        float start, float sweep, float[] dest) {
        int numPoints = GeometryBuilder.getPartialDiskVertexCount(slices, loops);
        int numCoords = 3 * numPoints;
    ...
    public static void makeRadialWallVertices(Terrain terrain, LatLon center, double innerRadius, double outerRadius,
    ...
    public static void makeRadialWallVertices(float innerRadius, float outerRadius, float height, float angle,
    ...
    public static void makeRadialWallOutlineIndices(int pillars, int stacks, int[] dest) {
    ...
    public static void makeLongCylinderVertices(Terrain terrain, LatLon center1, LatLon center2, double radius,
    ...
    public static void makeLongCylinderVertices(float radius, float length, float height,
    ...
    public static void makeLongCylinderOutlineIndices(int arcSlices, int lengthSlices, int stacks, int[] dest) {
        ...
        for (i = 0; i < slices; i++) {
            vertex = i;
            dest[index++] = vertex;
            dest[index++] = (i == slices - 1) ? 0 : vertex + 1;
        }
        // Top ring
        for (i = 0; i < slices; i++) {
            vertex = i + slices * stacks;
            dest[index++] = vertex;
            dest[index++] = (i == slices - 1) ? slices * stacks : vertex + 1;
        }
    }
    ...
    public static void makeLongDiskVertices(Terrain terrain, LatLon center1, LatLon center2, double innerRadius,
    ...
    public static void makeLongDiskVertices(float innerRadius, float outerRadius, float length,
    ...
    public static int computePolygonWindingOrder2(int pos, int count, Vec4[] points) {
        float area;
        int order;

        area = GeometryBuilder.computePolygonArea2(pos, count, points);
        if (area < 0.0f)
            order = GeometryBuilder.CLOCKWISE;
        else
            order = GeometryBuilder.COUNTER_CLOCKWISE;
    ...
    public static void subdivideIndexedTriangleBuffer(IndexedTriangleBuffer itb) {
        if (itb == null) {
        ...
        for (i = 0; i < indexCount; i += 3) {
            for (j = 0; j < 3; j++) {
                ...
                split = edgeMap.get(e);
                if (split == null) {
                    split = GeometryBuilder.splitVertex(itb, a, b);
                    edgeMap.put(e, split);
                }
            }
        }
        ...
        for (i = 0; i < indexCount; i += 3) {
            ...
            GeometryBuilder.indexSplitTriangle(itb, i, a, b, c, ab, bc, ca);
        }
    }

    private static int splitVertex(IndexedTriangleBuffer itb, int a, int b) {
    ...
    private static void indexSplitTriangle(IndexedTriangleBuffer itb, int original, int a, int b, int c, int ab, int bc,
        int ca) {
        int minCapacity, oldCapacity, newCapacity;
    ...
    public static void fixSphereSeam(IndexedTriangleBuffer itb, float wrapThreshold) {
        ...
        for (int i = 0; i < indexCount; i += 3) {
            ...
            if (wrapIndex >= 0)  // check if one of the vertices on this face wrapped across 2PI
            {
                ...
                if (newVertex == Integer.MIN_VALUE) {
                    ...
                    newVertex = GeometryBuilder.duplicateVertex(itb, wrapVertex);
    ...
    private static int duplicateVertex(IndexedTriangleBuffer itb, int sourceIndex) {
        if (itb == null) {
    ...
    public static void makeUnitSphereTextureCoordinates(IndexedTriangleBuffer itb, FloatBuffer texCoords) {
        if (itb == null) {
            String message = "nullValue.IndexedTriangleArray";
            Logging.logger().severe(message);
            throw new IllegalArgumentException(message);
    ...
    public static void makeUnitCylinderTextureCoordinates(int face, FloatBuffer texCoords, int slices) {
        if (texCoords == null) {
            String message = "nullValue.DestinationArrayIsNull";
            Logging.logger().severe(message);
            throw new IllegalArgumentException(message);
...
//        int slices = (int) Math.pow(2, 2 + subdivisions);
    ...
    public static void makeWedgeTextureCoordinates(FloatBuffer texCoords, int subdivisions, Angle angle) {
        ...
        int slices = (int) Math.pow(2, 2 + subdivisions);
        float da = (float) angle.radians() / slices;
    ...
    public static void subdivideIndexedTriangleArray(IndexedTriangleArray ita) {
        if (ita == null) {
            String message = "nullValue.IndexedTriangleArray";
            Logging.logger().severe(message);
            throw new IllegalArgumentException(message);
        ...
        for (i = 0; i < indexCount; i += 3) {
            for (j = 0; j < 3; j++) {
                ...
                split = edgeMap.get(e);
                if (split == null) {
                    split = GeometryBuilder.splitVertex(ita, a, b);
                    edgeMap.put(e, split);
                }
            }
        }
        ...
        for (i = 0; i < indexCount; i += 3) {
            ...
            bc = edgeMap.get(new Edge(b, c));
            ca = edgeMap.get(new Edge(c, a));
            GeometryBuilder.indexSplitTriangle(ita, i, a, b, c, ab, bc, ca);
        }
    }

    public static IndexedTriangleArray subdivideIndexedTriangles(int indexCount, int[] indices,
    ...
    private static int splitVertex(IndexedTriangleArray ita, int a, int b) {
        int minCapacity, oldCapacity, newCapacity;
    ...
    private static void indexSplitTriangle(IndexedTriangleArray ita, int original, int a, int b, int c, int ab, int bc,
        int ca) {
        int minCapacity, oldCapacity, newCapacity;
    ...
    public static int getBilinearSurfaceOutlineIndexCount(int uStacks, int vStacks, int mask) {
        int count = 0;
        if ((mask & GeometryBuilder.TOP) != 0)
            count += 2 * uStacks;
        if ((mask & GeometryBuilder.BOTTOM) != 0)
            count += 2 * uStacks;
        if ((mask & GeometryBuilder.LEFT) != 0)
            count += 2 * vStacks;
        if ((mask & GeometryBuilder.RIGHT) != 0)
            count += 2 * vStacks;
    ...
    public static void makeBilinearSurfaceOutlineIndices(int vertexPos, int uStacks, int vStacks, int mask, int destPos,
        int[] dest) {
    ...
    public static void makeBilinearSurfaceVertices(float[] control, int destPos, int uStacks, int vStacks,
        float[] dest) {
    ...
    public static FloatBuffer makeEllipse(float x, float y, float majorRadius, float minorRadius, int slices) {
        ...
        float step = (float) Math.PI * 2.0f / slices;
        float angle = 0;
     ...
     */
    public static FloatBuffer makeEllipseWithLeader(float x, float y, float majorRadius, float minorRadius, int slices,
        ...
        if (leaderCode == GeometryBuilder.LEADER_LOCATION_INSIDE)
            return GeometryBuilder.makeEllipse(x, y, majorRadius, minorRadius, slices);
        ...
        if ((leaderCode & GeometryBuilder.LEADER_LOCATION_BOTTOM) != 0) {
            // Limit the leader's width by the ellipse's major radius.
            float maxLeaderWidth = 2.0f * majorRadius;
            if (leaderWidth > maxLeaderWidth)
                leaderWidth = maxLeaderWidth;

            leaderAngle = leaderWidth / majorRadius;
            startAngle = 3.0f * (float) Math.PI / 2.0f;
        } else if ((leaderCode & GeometryBuilder.LEADER_LOCATION_TOP) != 0) {
            // Limit the leader's width by the ellipse's major radius.
            float maxLeaderWidth = 2.0f * majorRadius;
            if (leaderWidth > maxLeaderWidth)
                leaderWidth = maxLeaderWidth;
        ...
        } else if ((leaderCode & GeometryBuilder.LEADER_LOCATION_LEFT) != 0) {
            // Limit the leader's width by the ellipse's minor radius.
            float maxLeaderWidth = 2.0f * minorRadius;
            if (leaderWidth > maxLeaderWidth)
                leaderWidth = maxLeaderWidth;

            leaderAngle = leaderWidth / minorRadius;
            startAngle = (float) Math.PI;
        } else if ((leaderCode & GeometryBuilder.LEADER_LOCATION_RIGHT) != 0) {
            // Limit the leader's width by the ellipse's minor radius.
            float maxLeaderWidth = 2.0f * minorRadius;
            if (leaderWidth > maxLeaderWidth)
                leaderWidth = maxLeaderWidth;
        ...
        float angle = startAngle + leaderAngle / 2.0f;
        ...
        buffer.put(x + (float) Math.cos(startAngle + leaderAngle / 2.0f) * majorRadius);
        buffer.put(y + (float) Math.sin(startAngle + leaderAngle / 2.0f) * minorRadius);
     ...
     */
    public static FloatBuffer makeRectangle(float x, float y, float width, float height, float cornerRadius,
        int cornerSlices) {
        if (width < 0) {
            String message = Logging.getMessage("Geom.WidthIsNegative");
            Logging.logger().severe(message);
        ...
        float maxCornerRadius = Math.min(width, height) / 2.0f;
        ...
        GeometryBuilder.addRectangleRoundedCorner(x + cornerRadius, x + cornerRadius, cornerRadius, (float) Math.PI,
            piOver2,
            cornerSlices, buffer);
        ...
        buffer.put(y);
        GeometryBuilder.addRectangleRoundedCorner(x + width - cornerRadius, y + cornerRadius, cornerRadius, -piOver2,
            piOver2,
            cornerSlices, buffer);
        buffer.put(x + width);
        buffer.put(y + cornerRadius);
        ...
        GeometryBuilder.addRectangleRoundedCorner(x + width - cornerRadius, y + height - cornerRadius, cornerRadius,
            0.0f, piOver2,
            cornerSlices, buffer);
        buffer.put(x + width - cornerRadius);
        buffer.put(y + height);
        ...
        buffer.put(x + cornerRadius);
        buffer.put(y + height);
        GeometryBuilder.addRectangleRoundedCorner(x + cornerRadius, y + height - cornerRadius, cornerRadius, piOver2,
            piOver2,
            cornerSlices, buffer);
        buffer.put(x);
        buffer.put(y + height - cornerRadius);
    ...
    public static FloatBuffer makeRectangleWithLeader(float x, float y, float width, float height, float leaderX,
        ...
        if ((leaderCode & GeometryBuilder.LEADER_LOCATION_BOTTOM) != 0) {
            ...
            // Start in the leader right corner to ensure the vertices can be drawn as a triangle fan.
            buffer.put(x + width / 2.0f + leaderWidth / 2.0f);
            buffer.put(y);
            // Lower right corner.
            buffer.put(x + width);
            buffer.put(y);
            ...
            buffer.put(x);
            buffer.put(y + height / 2.0f - leaderWidth / 2.0f);
            // Lower left corner.
            buffer.put(x);
            buffer.put(y);
            // Lower right corner.
     ...
     */
    public static FloatBuffer makeRectangleWithLeader(float x, float y, float width, float height, float cornerRadius,
        ...
        // Create a rectangle with sharp corners if either the corner radius or the number of corner slices is 0.
        if (cornerRadius == 0.0f || cornerSlices == 0)
            return GeometryBuilder.makeRectangleWithLeader(x, y, width, height, leaderX, leaderY, leaderWidth);

        // Return a rectangle without a leader if the leader width is zero.
        if (leaderWidth == 0)
            return GeometryBuilder.makeRectangle(x, y, width, height, cornerRadius, cornerSlices);
        ...
        if ((leaderCode & GeometryBuilder.LEADER_LOCATION_BOTTOM) != 0) {
            ...
            float maxLeaderWidth = width - 2.0f * cornerRadius;
            if (leaderWidth > maxLeaderWidth)
                leaderWidth = maxLeaderWidth;
            ...
            buffer.put(x + width - cornerRadius);
            buffer.put(y);
            GeometryBuilder.addRectangleRoundedCorner(x + width - cornerRadius, y + cornerRadius, cornerRadius,
                -piOver2, piOver2,
                cornerSlices, buffer);
            buffer.put(x + width);
            buffer.put(y + cornerRadius);
            ...
            buffer.put(x + cornerRadius);
            buffer.put(y + height);
            GeometryBuilder.addRectangleRoundedCorner(x + cornerRadius, y + height - cornerRadius, cornerRadius,
                piOver2, piOver2,
                cornerSlices, buffer);
            buffer.put(x);
            buffer.put(y + height - cornerRadius);
            ...
            float maxLeaderWidth = height - 2.0f * cornerRadius;
            if (leaderWidth > maxLeaderWidth)
                leaderWidth = maxLeaderWidth;
     ...
     */
    protected static int computeLeaderLocationCode(float x1, float y1, float x2, float y2, float leaderX,
        float leaderY) {
        return (leaderY > y2 ? GeometryBuilder.LEADER_LOCATION_TOP : 0)   // bit 0: top
            | (leaderY < y1 ? GeometryBuilder.LEADER_LOCATION_BOTTOM : 0) // bit 1: bottom
            | (leaderX > x2 ? GeometryBuilder.LEADER_LOCATION_RIGHT : 0)  // bit 2: right
            | (leaderX < x1 ? GeometryBuilder.LEADER_LOCATION_LEFT : 0);  // bit 3: left
    }
    ...
    private static void facenorm(float[] srcVerts, int vertA, int vertB, int vertC, float[] dest) {
        int ia, ib, ic;
        float[] ab, ac;
    ...
    private static void facenorm(FloatBuffer srcVerts, int vertA, int vertB, int vertC, float[] dest) {
        int ia, ib, ic;
        float[] ab, ac;
    ...
    private static void append(Terrain terrain, LatLon ll, double altitude, boolean terrainConformant, Vec4 refPoint,
        ...
        GeometryBuilder.coord[2] = (float) (point.z - refPoint.z);
        dest.put(GeometryBuilder.coord);
    }
    ...
    public IndexedTriangleArray tessellateSphere(float radius, int subdivisions) {
        ...
        int[] indexArray = new int[GeometryBuilder.ICOSAHEDRON_INDEX_COUNT];
        float[] vertexArray = new float[3 * GeometryBuilder.ICOSAHEDRON_VERTEX_COUNT];
        System.arraycopy(GeometryBuilder.icosahedronIndexArray, 0, indexArray, 0, GeometryBuilder.ICOSAHEDRON_INDEX_COUNT);
        System.arraycopy(GeometryBuilder.icosahedronVertexArray, 0, vertexArray, 0, 3 * GeometryBuilder.ICOSAHEDRON_VERTEX_COUNT);
        ...
        if (this.orientation == GeometryBuilder.INSIDE) {
            for (int index = 0; index < GeometryBuilder.ICOSAHEDRON_INDEX_COUNT; index += 3) {
        ...
        IndexedTriangleArray ita = new IndexedTriangleArray(
            GeometryBuilder.ICOSAHEDRON_INDEX_COUNT, indexArray, GeometryBuilder.ICOSAHEDRON_VERTEX_COUNT, vertexArray);
        ...
        for (int i = 0; i < subdivisions; i++) {
            ...
            for (int vertex = 0; vertex < ita.vertexCount; vertex++) {
                GeometryBuilder.norm3AndSet(vertexArray, 3 * vertex);
            }
        }
        ...
        if (radius != 1) {
            vertexArray = ita.getVertices();
            for (int vertex = 0; vertex < ita.vertexCount; vertex++) {
                GeometryBuilder.mul3AndSet(vertexArray, 3 * vertex, radius);
            }
        }
    ...
    public IndexedTriangleBuffer tessellateSphereBuffer(float radius, int subdivisions) {
        ...
        IntBuffer indexBuffer = Buffers.newDirectIntBuffer(GeometryBuilder.ICOSAHEDRON_INDEX_COUNT);
        FloatBuffer vertexBuffer = Buffers.newDirectFloatBuffer(3 * GeometryBuilder.ICOSAHEDRON_VERTEX_COUNT);
        indexBuffer.put(GeometryBuilder.icosahedronIndexArray, 0, GeometryBuilder.ICOSAHEDRON_INDEX_COUNT);
        vertexBuffer.put(GeometryBuilder.icosahedronVertexArray, 0, 3 * GeometryBuilder.ICOSAHEDRON_VERTEX_COUNT);
        ...
        IndexedTriangleBuffer itb = new IndexedTriangleBuffer(
            GeometryBuilder.ICOSAHEDRON_INDEX_COUNT, indexBuffer, GeometryBuilder.ICOSAHEDRON_VERTEX_COUNT, vertexBuffer);

        // Subdivide the icosahedron a specified number of times. The subdivison step computes midpoints between
        // adjacent vertices. These midpoints are not on the sphere, but must be moved onto the sphere. We normalize
        // each midpoint vertex to achieve this.
        for (int i = 0; i < subdivisions; i++) {
            GeometryBuilder.subdivideIndexedTriangleBuffer(itb);

            vertexBuffer = itb.getVertices();
            for (int vertex = 0; vertex < itb.getVertexCount(); vertex++) {
                GeometryBuilder.norm3AndSet(vertexBuffer, 3 * vertex);
            }
        }
        ...
        if (radius != 1) {
            ...
            for (int vertex = 0; vertex < itb.vertexCount; vertex++) {
                GeometryBuilder.mul3AndSet(vertexBuffer, 3 * vertex, radius);
            }
        }
    ...
    public IndexedTriangleBuffer tessellateEllipsoidBuffer(float a, float b, float c, int subdivisions) {
        ...
        for (int vertex = 0; vertex < itb.getVertexCount(); vertex++) {
            ...
            GeometryBuilder.mulAndSet(vertexBuffer, 3 * vertex, bScale, 2);
            GeometryBuilder.mulAndSet(vertexBuffer, 3 * vertex, cScale, 1);
        }
    ...
    public IndexedTriangleBuffer tessellateBoxBuffer(float radius, int subdivisions) {
        ...
        IntBuffer indexBuffer = Buffers.newDirectIntBuffer(GeometryBuilder.BOX_INDEX_COUNT);
        FloatBuffer vertexBuffer = Buffers.newDirectFloatBuffer(3 * GeometryBuilder.BOX_VERTEX_COUNT);
        indexBuffer.put(GeometryBuilder.boxIndexArray, 0, GeometryBuilder.BOX_INDEX_COUNT);
        vertexBuffer.put(GeometryBuilder.boxVertexArray, 0, 3 * GeometryBuilder.BOX_VERTEX_COUNT);

        // The static box tessellation is assumed to be viewed from the outside. If the orientation is set to
        // inside, then we must reverse the winding order for each triangle's indices.
        if (this.orientation == GeometryBuilder.INSIDE) {
            for (int index = 0; index < GeometryBuilder.BOX_INDEX_COUNT; index += 3) {
                int tmp = indexBuffer.get(index);
                indexBuffer.put(index, indexBuffer.get(index + 2));
                indexBuffer.put(index + 2, tmp);
            }
        ...
        IndexedTriangleBuffer itb = new IndexedTriangleBuffer(
            GeometryBuilder.BOX_INDEX_COUNT, indexBuffer, GeometryBuilder.BOX_VERTEX_COUNT, vertexBuffer);
    ...
    public IndexedTriangleBuffer tessellateBoxBuffer(int face, float radius, int subdivisions) {
        ...
        IntBuffer indexBuffer = Buffers.newDirectIntBuffer(GeometryBuilder.BOX_INDEX_COUNT / 6);
        FloatBuffer vertexBuffer = Buffers.newDirectFloatBuffer(3 * GeometryBuilder.BOX_VERTEX_COUNT / 6);

        // fill subset of index buffer
        int[] subArray = new int[GeometryBuilder.BOX_INDEX_COUNT / 6];
        System.arraycopy(
            GeometryBuilder.boxFacesIndexArray, face * 36 / 6 + 0, subArray, 0, GeometryBuilder.BOX_INDEX_COUNT / 6);
        indexBuffer.put(subArray, 0, GeometryBuilder.BOX_INDEX_COUNT / 6);

        float[] vertexSubset = new float[3 * GeometryBuilder.BOX_VERTEX_COUNT / 6];
        System.arraycopy(GeometryBuilder.boxVertexArray, face * 3 * GeometryBuilder.BOX_VERTEX_COUNT / 6 + 0, vertexSubset, 0,
            3 * GeometryBuilder.BOX_VERTEX_COUNT / 6);
        vertexBuffer.put(vertexSubset, 0, 3 * GeometryBuilder.BOX_VERTEX_COUNT / 6);

        // The static box tessellation is assumed to be viewed from the outside. If the orientation is set to
        // inside, then we must reverse the winding order for each triangle's indices.
        if (this.orientation == GeometryBuilder.INSIDE) {
            for (int index = 0; index < GeometryBuilder.BOX_INDEX_COUNT / 6; index += 3) {
                int tmp = indexBuffer.get(index);
                indexBuffer.put(index, indexBuffer.get(index + 2));
                indexBuffer.put(index + 2, tmp);
            }
        ...
        // Start with a tessellated box.
        IndexedTriangleBuffer itb = new IndexedTriangleBuffer(
            GeometryBuilder.BOX_INDEX_COUNT / 6, indexBuffer, GeometryBuilder.BOX_VERTEX_COUNT / 6, vertexBuffer);
    ...
    public IndexedTriangleBuffer tessellatePyramidBuffer(float radius, int subdivisions) {
        ...
        IntBuffer indexBuffer = Buffers.newDirectIntBuffer(GeometryBuilder.PYRAMID_INDEX_COUNT);
        FloatBuffer vertexBuffer = Buffers.newDirectFloatBuffer(3 * GeometryBuilder.PYRAMID_VERTEX_COUNT);
        indexBuffer.put(GeometryBuilder.pyramidIndexArray, 0, GeometryBuilder.PYRAMID_INDEX_COUNT);
        vertexBuffer.put(GeometryBuilder.pyramidVertexArray, 0, 3 * GeometryBuilder.PYRAMID_VERTEX_COUNT);

        // The static box tessellation is assumed to be viewed from the outside. If the orientation is set to
        // inside, then we must reverse the winding order for each triangle's indices.
        if (this.orientation == GeometryBuilder.INSIDE) {
            for (int index = 0; index < GeometryBuilder.PYRAMID_INDEX_COUNT; index += 3) {
                int tmp = indexBuffer.get(index);
                indexBuffer.put(index, indexBuffer.get(index + 2));
                indexBuffer.put(index + 2, tmp);
            }
        ...
        IndexedTriangleBuffer itb = new IndexedTriangleBuffer(
            GeometryBuilder.PYRAMID_INDEX_COUNT, indexBuffer, GeometryBuilder.PYRAMID_VERTEX_COUNT, vertexBuffer);
    ...
    public IndexedTriangleBuffer tessellatePyramidBuffer(int face, float radius, int subdivisions) {
        ...
        System.arraycopy(GeometryBuilder.pyramidFacesIndexArray, faceIndicesOffset + 0, subArray, 0, faceIndexCount);
        indexBuffer.put(subArray, 0, faceIndexCount);

        float[] vertexSubset = new float[3 * faceVertexCount];
        System.arraycopy(GeometryBuilder.pyramidVertexArray, faceVerticesOffset + 0, vertexSubset, 0, 3 * faceVertexCount);
    ...
    public IndexedTriangleBuffer tessellateCylinderBuffer(float radius, int slices) {
        if (radius < 0) {
            String message = Logging.getMessage("generic.ArgumentOutOfRange", "radius < 0");
            Logging.logger().severe(message);
            throw new IllegalArgumentException(message);
...
//        int slices = (int) Math.pow(2, 2 + subdivisions);
        ...
        vertexBuffer.put(0, 0.0f);
        vertexBuffer.put(1, 0.0f);
        vertexBuffer.put(2, 1.0f);

        vertexBuffer.put(3 * (slices + 1), 0.0f);
        vertexBuffer.put(3 * (slices + 1) + 1, 0.0f);
...
//        int centerPoint = 0;
    ...
    public IndexedTriangleBuffer tessellateCylinderBuffer(int face, float radius, int slices) {
        if (radius < 0) {
            String message = Logging.getMessage("generic.ArgumentOutOfRange", "radius < 0");
            Logging.logger().severe(message);
            throw new IllegalArgumentException(message);
    ...
    public IndexedTriangleBuffer tessellateWedgeBuffer(float radius, int subdivisions, Angle angle) {
        ...
        vertexBuffer.put(3 * (slices + 2), 0.0f);
        vertexBuffer.put(3 * (slices + 2) + 1, 0.0f);
        ...
        // wedge sides
        for (i = 0; i < 2; i++) {
            x = (float) Math.sin(i * angle.radians());
            y = (float) Math.cos(i * angle.radians());
            z = 1.0f;
    ...
    public void makeCylinderNormals(int slices, int stacks, float[] dest) {
        ...
        da = 2.0f * (float) Math.PI / slices;
        nsign = (this.orientation == GeometryBuilder.OUTSIDE) ? 1.0f : -1.0f;
        norm = new float[3];
        ...
        for (l = 0; l <= loops; l++) {
            ...
            if (l == 0 || l == loops) {
                ...
                if (l == 0 && (innerMinorRadius == 0.0f || outerMinorRadius == 0)) {
                    ...
                    for (s = 0; s < slices; s++) {
                        ...
                        GeometryBuilder.facenorm(srcVerts, index, nextSlice + 1, adjacentLoop, tmp);
                ...
                // Open disk: each slice has a unique starting point.
                    ...
                    for (s = 0; s < slices; s++) {
                        ...
                        if (l == 0)
                            GeometryBuilder.facenorm(srcVerts, index, nextSlice, adjacentLoop, tmp);
                        else
                            GeometryBuilder.facenorm(srcVerts, index, adjacentLoop, nextSlice, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                        // Add counter-clockwise adjacent face.
                        if (l == 0)
                            GeometryBuilder.facenorm(srcVerts, index, adjacentLoop, prevSlice, tmp);
                        else
                            GeometryBuilder.facenorm(srcVerts, index, prevSlice, adjacentLoop, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
            ...
            // Normal vectors for internal loops.
                ...
                for (s = 0; s < slices; s++) {
                    ...
                    GeometryBuilder.facenorm(srcVerts, index, prevSlice, prevSlice - 1, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    GeometryBuilder.facenorm(srcVerts, index, prevSlice - 1, prevLoop, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    // Add lower-right adjacent face.
                    GeometryBuilder.facenorm(srcVerts, index, prevLoop, nextSlice - 1, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    GeometryBuilder.facenorm(srcVerts, index, nextSlice - 1, nextSlice, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    // Add upper-right adjacent face.
                    GeometryBuilder.facenorm(srcVerts, index, nextSlice, nextSlice + 1, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    GeometryBuilder.facenorm(srcVerts, index, nextSlice + 1, nextLoop, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    // Add upper-left adjacent face.
                    GeometryBuilder.facenorm(srcVerts, index, nextLoop, prevSlice + 1, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    GeometryBuilder.facenorm(srcVerts, index, prevSlice + 1, prevSlice, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
        ...
        for (l = 0; l <= loops; l++) {
            ...
            if (l == 0 || l == loops) {
                ...
                if (l == 0 && innerRadius == 0.0f) {
                    // Top arc.
                    {
                        ...
                        for (s = 0; s <= arcSlices; s++) {
                            index = s;
                            GeometryBuilder.facenorm(srcVerts, index, index + slices + 1, index + slices, tmp);
                            GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                        }
                        index = arcSlices;
                        GeometryBuilder.facenorm(srcVerts, index, index + 1, index + slices, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                        index = 0;
                        GeometryBuilder.facenorm(srcVerts, index, index + slices, index + slices - 1, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                        GeometryBuilder.mul3AndSet(norm, 0, nsign);
                        GeometryBuilder.norm3AndSet(norm, 0);
                        // Copy common normal to the first point of each slice.
                    ...
                    // Right and left sides.
                    {
                        ...
                        for (s = 1; s < lengthSlices; s++) {
                            ...
                            System.arraycopy(zero, 0, norm, 0, 3);
                            GeometryBuilder.facenorm(srcVerts, index, index + slices, index - 1, tmp);
                            GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                            GeometryBuilder.facenorm(srcVerts, index, index + 1, index + slices, tmp);
                            GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                            if (s == 1)
                                GeometryBuilder.facenorm(srcVerts, leftSideIndex, leftSideIndex - slices + 1,
                                    leftSideIndex + slices, tmp);
                            else
                                GeometryBuilder.facenorm(srcVerts, leftSideIndex, leftSideIndex + 1,
                                    leftSideIndex + slices, tmp);
                            GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                            GeometryBuilder.facenorm(srcVerts, leftSideIndex, leftSideIndex + slices, leftSideIndex - 1,
                                tmp);
                            GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                            GeometryBuilder.mul3AndSet(norm, 0, nsign);
                            GeometryBuilder.norm3AndSet(norm, 0);
            ...
            // Normal vectors for internal loops.
                ...
                for (s = 0; s < slices; s++) {
                    ...
                    // Add lower-left adjacent face.
                    GeometryBuilder.facenorm(srcVerts, index, prevSlice, prevSlice - slices, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    GeometryBuilder.facenorm(srcVerts, index, prevSlice - slices, prevLoop, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    // Add lower-right adjacent face.
                    GeometryBuilder.facenorm(srcVerts, index, prevLoop, nextSlice - slices, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    GeometryBuilder.facenorm(srcVerts, index, nextSlice - slices, nextSlice, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    // Add upper-right adjacent face.
                    GeometryBuilder.facenorm(srcVerts, index, nextSlice, nextSlice + slices, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    GeometryBuilder.facenorm(srcVerts, index, nextSlice + slices, nextLoop, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    // Add upper-left adjacent face.
                    GeometryBuilder.facenorm(srcVerts, index, nextLoop, prevSlice + slices, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    GeometryBuilder.facenorm(srcVerts, index, prevSlice + slices, prevSlice, tmp);
                    GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
    ...
    public void makeIndexedTriangleBufferNormals(int indexPos, int indexCount, IntBuffer indices,
        ...
        for (i = 0; i < indexCount; i += 3) {
            ...
            GeometryBuilder.facenorm(vertices, faceIndices[0], faceIndices[1], faceIndices[2], norm);
        ...
        for (vi = 0; vi <= vStacks; vi++) {
            for (ui = 0; ui <= uStacks; ui++) {
                ...
                if (vi > 0) {
                    ...
                    if (ui > 0) {
                        GeometryBuilder.facenorm(srcVerts, index, index - 1, vprev - 1, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                        GeometryBuilder.facenorm(srcVerts, index, vprev - 1, vprev, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    }
                    // Adjacent faces below and to the right.
                    if (ui < uStacks) {
                        GeometryBuilder.facenorm(srcVerts, index, vprev, vprev + 1, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                        GeometryBuilder.facenorm(srcVerts, index, vprev + 1, index + 1, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    }
                }
                ...
                if (vi < vStacks) {
                    ...
                    if (ui > 0) {
                        GeometryBuilder.facenorm(srcVerts, index, vnext, vnext - 1, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                        GeometryBuilder.facenorm(srcVerts, index, vnext - 1, index - 1, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    }
                    // Adjacent faces above and to the right.
                    if (ui < uStacks) {
                        GeometryBuilder.facenorm(srcVerts, index, index + 1, vnext + 1, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                        GeometryBuilder.facenorm(srcVerts, index, vnext + 1, vnext, tmp);
                        GeometryBuilder.add3AndSet(norm, 0, tmp, 0);
                    }
                }
    ...
    private static class TessellatorCallback extends GLUtessellatorCallbackAdapter {
        private final GeometryBuilder gb;
