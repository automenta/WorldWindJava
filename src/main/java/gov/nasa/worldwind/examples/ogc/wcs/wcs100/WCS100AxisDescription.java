...
package gov.nasa.worldwind.examples.ogc.wcs.wcs100;
...
public class WCS100AxisDescription extends AbstractXMLEventParser {
    protected final Collection<String> axisNames = new ArrayList<>(2);
    protected final Collection<String> offsetVectors = new ArrayList<>(2);
