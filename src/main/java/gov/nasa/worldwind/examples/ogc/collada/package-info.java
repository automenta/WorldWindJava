 ...
 * <ol>
 * <li>
 * Create a {@link gov.nasa.worldwind.examples.ogc.collada.ColladaRoot} via one of its constructors, such as {@link
 * gov.nasa.worldwind.examples.ogc.collada.ColladaRoot#ColladaRoot(java.io.File)}, passing the COLLADA source to the constructor.
 * A <code>ColladaRoot</code> provides access to the COLLADA contents. The source can be either a file, an input stream,
 * or a URL.
 * </li>
 * <li>
 * Call {@link gov.nasa.worldwind.examples.ogc.collada.ColladaRoot#parse(Object[])} to parse the document.
 * </li>
 * <li>
 ...
 * gov.nasa.worldwind.examples.ogc.collada.ColladaResourceResolver}.</p>
 */
package gov.nasa.worldwind.examples.ogc.collada;
