...
package gov.nasa.worldwind.examples.ogc.kml.impl;
...
public class KMLUtil {
     ...
     */
    public static java.util.List<Position> computeAltitude(Globe globe, Collection<? extends Position> positions,
        String altitudeMode) {
     ...
     */
    public static List<LatLon> rotateSector(Globe globe, Sector sector, Angle rotation) {
        if (globe == null) {
        ...
        List<LatLon> transformedCorners = new ArrayList<>(corners.length);
