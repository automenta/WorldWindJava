...
package gov.nasa.worldwind.examples.ogc;
    ...
    protected void doParseEventContent(XMLEventParserContext ctx, XMLEvent event, Object... args)
        ...
        if (ctx.isStartElement(event, CONTACT_POSITION)) {
            ...
            if (parser != null) {
                ...
                if (o instanceof OGCAddress)
                    this.setContactAddress((OGCAddress) o);
            }
        }
    }

    protected String[] parseContactPersonPrimary(XMLEventParserContext ctx, XMLEvent cppEvent)
        throws XMLStreamException {
