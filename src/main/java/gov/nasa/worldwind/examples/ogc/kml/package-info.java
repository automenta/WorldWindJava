 ...
 * <ol>
 * <li>
 * Create a {@link gov.nasa.worldwind.examples.ogc.kml.KMLRoot} via one of its constructors, such as {@link
 * gov.nasa.worldwind.examples.ogc.kml.KMLRoot#KMLRoot(java.io.File)}, passing the KML or KMZ source to the constructor. A
 * <code>KMLRoot</code> provides access to the KML contents. The source can be either a file, an input stream or a URL.
 * </li>
 * <li>
 * Call {@link gov.nasa.worldwind.examples.ogc.kml.KMLRoot#parse(Object[])} to parse the document.
 * </li>
 * <li>
 ...
 * file, stream, KML or KMZ &#151; and is provided by the {@link gov.nasa.worldwind.examples.ogc.kml.io.KMLDoc} interface and its
 * implementing classes. It's available from the {@link gov.nasa.worldwind.examples.ogc.kml.KMLRoot}. See the description of the
