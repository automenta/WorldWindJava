...
package gov.nasa.worldwind.examples.ogc.collada.impl;
...
public class ColladaMeshShape extends AbstractGeneralShape {
    ...
    /**
     * {@inheritDoc} Does nothing, all drawing is performed by {@link #doDrawInterior(DrawContext)}.
     */
    @Override
    ...
    protected Extent computeExtent(DrawContext dc) {
        ...
        Collection<Vec4> extrema = new ArrayList<>();
    ...
    protected static class Geometry {
         ...
         *
         * @see ColladaMeshShape#isDoubleSided(ColladaAbstractGeometry)
         */
