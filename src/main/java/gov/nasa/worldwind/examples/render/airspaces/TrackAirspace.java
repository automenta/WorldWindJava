 ...
 * All Rights Reserved.
 */
package gov.nasa.worldwind.examples.render.airspaces;
 ...
 * gov.nasa.worldwind.examples.render.airspaces.Box} objects.
 *
 * @author garakl
...
public class TrackAirspace extends AbstractAirspace {
    ...
    public TrackAirspace(Iterable<Box> legs) {
        this.addLegs(legs);
    }
    ...
    protected void doRestoreState(RestorableSupport rs, RestorableSupport.StateObject context) {
        ...
        List<Box> legList = new ArrayList<>(lsos.length);
