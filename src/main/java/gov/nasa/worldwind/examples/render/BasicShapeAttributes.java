...
/**
 * Basic implementation of the {@link ShapeAttributes} interface.
 *
 * @author dcollins
...
public class BasicShapeAttributes implements ShapeAttributes {
     ...
     * <tr><td>interiorMaterial</td><td>{@link Material#WHITE}</td></tr>
     * <tr><td>outlineMaterial</td><td>{@link Material#BLACK}</td></tr>
