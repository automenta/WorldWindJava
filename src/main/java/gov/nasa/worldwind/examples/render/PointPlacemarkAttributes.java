...
public class PointPlacemarkAttributes implements Exportable {
    ...
    public static final String DEFAULT_IMAGE_PATH =
        Configuration.getStringValue("gov.nasa.worldwind.examples.render.PointPlacemarkAttributes.DefaultImagePath",
    ...
    public static final Font DEFAULT_LABEL_FONT = Font.decode(
        Configuration.getStringValue("gov.nasa.worldwind.examples.render.PointPlacemarkAttributes.DefaultLabelFont",
            "Arial-BOLD-14"));
    /**
