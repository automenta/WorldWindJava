...
/**
 * Basic implementation of the {@link BalloonAttributes} interface. Extends
 * <code>BasicShapeAttributes</code> to include attributes for WorldWind {@link Balloon}
 * shapes.
 *
 * @author pabercrombie
...
public class BasicBalloonAttributes extends BasicShapeAttributes implements BalloonAttributes {
     ...
     */
    public BasicBalloonAttributes(ShapeAttributes attributes) {
        if (attributes == null) {
