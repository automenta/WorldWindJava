...
public class Size {
     ...
     */
    public static final String NATIVE_DIMENSION = "gov.nasa.worldwind.examples.render.Size.NativeDimension";

    /**
     * Size mode to indicate that the content's aspect ratio must be maintained.
     */
    public static final String MAINTAIN_ASPECT_RATIO = "gov.nasa.worldwind.examples.render.Size.MaintainAspectRatio";
     ...
     */
    public static final String EXPLICIT_DIMENSION = "gov.nasa.worldwind.examples.render.Size.ExplicitDimension";
