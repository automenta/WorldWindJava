...
public interface Factory {
     ...
     * @throws IllegalArgumentException                             if the configuration source is null or an empty
     *                                                              string.
     * @throws gov.nasa.worldwind.exception.WWUnrecognizedException if the type of source or some object-specific value
     *                                                              is unrecognized.
     * @throws gov.nasa.worldwind.exception.WWRuntimeException      if object creation fails. The exception indicating
