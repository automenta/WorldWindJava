...
public class SegmentPlane extends WWObjectImpl
{
    public static class ControlPoint
    {
        ...
        private final double uCoordinate;
        private final double vCoordinate;
        private final boolean relativeToSurface;
    ...
    private final List<ControlPoint> controlPointList;
