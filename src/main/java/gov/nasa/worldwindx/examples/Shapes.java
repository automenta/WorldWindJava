...
public class Shapes {
    ...
    protected static class AppFrame extends JFrame {
        ...
        private final TextRenderer textRenderer = new TextRenderer(java.awt.Font.decode("Arial-Plain-13"), true, false);
        ...
        private final ArrayList<JComponent> onTerrainOnlyItems = new ArrayList<>();
