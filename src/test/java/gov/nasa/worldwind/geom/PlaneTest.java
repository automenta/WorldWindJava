...
public class PlaneTest
{
    ...
    public void testSegmentIntersection()
    {
        ...
        assertEquals("Perpendicular, 0 at origin, should produce intersection at origin", pt, Vec4.ZERO);
        ...
        assertEquals("Line segment is in fact a point, located on the plane, should produce intersection at (1, 0, 0)",
            pt, new Vec4(1, 0, 0));
        ...
        assertEquals("Perpendicular, integer end points off origin, should produce intersection at origin", pt,
            Vec4.ZERO);
        ...
        assertEquals("Perpendicular, non-integer end points off origin, should produce intersection at origin", pt,
            Vec4.ZERO);
        ...
        assertEquals("Not perpendicular, non-integer end points off origin, should produce intersection at origin", pt,
            Vec4.ZERO);

        pt = p.intersect(new Vec4(1, 0, 0), new Vec4(2, 0, 0));
        assertNotNull("Parallel, in plane, not null", pt);
        assertEquals("Parallel, in plane, should produce intersection at origin", pt, Vec4.INFINITY);
