 ...
 * type of shape. Each of these editors is descended from the {@link gov.nasa.worldwind.examples.shapebuilder.AbstractShapeEditor}
 * abstract class, and the editors for the rigid shapes extend further from {@link
 * gov.nasa.worldwind.examples.shapebuilder.RigidShapeEditor}. </p>
 *
 * <p>
 * The main shape building application in the package is {@link gov.nasa.worldwind.examples.shapebuilder.RigidShapeBuilder}.
 * This example allows the user to select the desired shape from a dropdown menu, create an instance of it with the
 * click of a button, and specify an "edit mode" for modifying the shape: move, scale, rotate or skew. Numerous shapes
 * may be created and placed on the globe together, but only one may be selected and edited at any given time. </p>
 *
 * <p>
 ...
 * different editors for the different shapes: {@link gov.nasa.worldwind.examples.shapebuilder.BoxEditor}, {@link
 * gov.nasa.worldwind.examples.shapebuilder.CylinderEditor}, {@link gov.nasa.worldwind.examples.shapebuilder.ConeEditor},
 * {@link gov.nasa.worldwind.examples.shapebuilder.PyramidEditor}, {@link gov.nasa.worldwind.examples.shapebuilder.WedgeEditor},
