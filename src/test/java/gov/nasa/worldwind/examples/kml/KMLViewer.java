...
public class KMLViewer extends ApplicationTemplate {
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame {
        ...
        public AppFrame() {
            ...
            this.layerTree.getModel().refresh(this.wwd().model().layers());
            ...
            this.wwd().model().layers().add(this.hiddenLayer);
        ...
        protected void addKMLLayer(KMLRoot kmlRoot) {
            ...
            Renderable kmlController = new KMLController(kmlRoot);
    ...
    public static class WorkerThread extends Thread {
         ...
         *                  InputStream}, or a {@link String} identifying a file path or URL.
        ...
        /**
         * Loads this worker thread's KML source into a new <code>{@link KMLRoot}</code>,
