...
//import gov.nasa.worldwind.examples.worldwindow.util.ShadedPanel;
...
//    private final ShadedPanel panel;
//    private final Color panelTextColor = new Color(0x184984);
...
//    @Override public void accept(SelectEvent event) {
//        if (event.isRollover()) {
