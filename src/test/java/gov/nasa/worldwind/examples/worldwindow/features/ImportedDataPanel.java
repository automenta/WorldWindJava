 ...
 * that data. Callers fill the panel with imported data by invoking {@link #addImportedData(Element,
 * AVList)}. This adds the UI components for a specified data set (a "Go To" button, and a
...
public class ImportedDataPanel extends ShadedPanel {
     ...
     * configured to accept imported data via calls to {@link #addImportedData(Element,
     * AVList)}.
     *
