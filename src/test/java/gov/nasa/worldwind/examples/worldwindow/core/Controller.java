...
import gov.nasa.worldwind.examples.worldwindow.core.layermanager.LayerManager;
import gov.nasa.worldwind.examples.worldwindow.features.NetworkActivitySignal;
...
public class Controller {
    ...
    public void moveToLocation(LatLon location) {
        ...
        this.moveToLocation(new Position(location, newAlt));
    }
    ...
    public void showErrorDialogLater(final Exception e, final String title, final String message,
        final Object... args) {
    ...
    public File chooseOutputFile(String defaultName, String suffixWithoutDot, String dialogTitle) {
        ...
        if (suffixWithoutDot != null && !suffixWithoutDot.isEmpty())
