...
public class SARSegmentPlane extends WWObjectImpl {
    ...
    private final SegmentPlaneEditor segmentPlaneEditor;
    private final SegmentPlaneController segmentPlaneController;
    ...
    protected static Angle computeInitialHorizontalGap(WorldWindow wwd, SegmentPlane segmentPlane,
        ...
        double gridWidthRadians = gridCellDimensions[0] / wwd.model().globe().getRadius();
    ...
    public void setWorldWindow(WorldWindow wwd) {
        ...
        if (this.wwd != null) {
            ...
            if (this.wwd.model().layers().contains(this.segmentPlaneEditor)) {
                this.wwd.model().layers().remove(this.segmentPlaneEditor);
            }
        }
        ...
        if (this.wwd != null) {
            ...
            if (!this.wwd.model().layers().contains(this.segmentPlaneEditor)) {
                this.wwd.model().layers().add(this.segmentPlaneEditor);
            }
        }
    }
