...
public class SARAnnotationSupport {
    ...
    private final AnnotationAttributes defaults;
    private final ScreenAnnotation helpMessageAnnotation;
    ...
    private void updateHelpMessage(Locatable annotation) {
        if (annotation != null) {
    ...
    public Iterable<SARAnnotation> getAnnotationsForTrack(SARTrack owner) {
        List<SARAnnotation> result = new ArrayList<>();
