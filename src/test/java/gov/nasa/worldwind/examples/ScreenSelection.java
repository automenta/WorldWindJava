...
/**
 * Demonstrates how to use the {@link ScreenSelector} utility to perform
...
public class ScreenSelection extends ApplicationTemplate {
    ...
    protected static class SelectionHighlightController extends HighlightController implements MessageListener {
        protected final ScreenSelector screenSelector;
        protected final Collection<Highlightable> lastBoxHighlightObjects = new ArrayList<>();
        ...
        protected void highlightSelectedObjects(Iterable<?> list) {
