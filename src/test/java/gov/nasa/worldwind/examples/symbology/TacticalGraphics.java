...
public class TacticalGraphics extends ApplicationTemplate {
    public static void main(String[] args) {
        Configuration.setValue(Keys.INITIAL_LATITUDE, 34.90);
        Configuration.setValue(Keys.INITIAL_LONGITUDE, -117.44);
        Configuration.setValue(Keys.INITIAL_ALTITUDE, 155000);
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame {
        ...
        protected void createPointGraphics(RenderableLayer layer) {
            ...
            graphic.set(Keys.DISPLAY_NAME, "Nuclear Event (2.X.3.4.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "High Tower");
        ...
        protected void createLineGraphics(RenderableLayer layer) {
            ...
            graphic.set(Keys.DISPLAY_NAME, "Phase line: friendly (2.X.2.2.2.2)");
            graphic.setText("A");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Phase line: hostile (2.X.2.2.2.2)");
            graphic.setText("B");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Phase line: hostile, anticipated (2.X.2.2.2.2)");
            graphic.setText("C");
            layer.add(graphic);
            ...
            graphic = factory.createGraphic("GFGPGLP----AUSX", positions, null);
            graphic.setText("D");
            graphic.set(Keys.DISPLAY_NAME, "Phase line: custom color and font (2.X.2.2.2.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Boundary (2.X.2.1.2.1)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Main Attack (2.X.2.5.2.1.4.1)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Attack, Rotary Wing (2.X.2.5.2.1.3)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Aviation (2.X.2.5.2.1.1)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Supporting Attack (2.X.2.5.2.1.4.2)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Airborne (2.X.2.5.2.1.2)");
            ...
            route.set(Keys.DISPLAY_NAME, "Minimum Risk Route (2.X.2.2.2.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Direction of Main Attack (2.X.2.5.2.2.2.1)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Final Protective Fire (2.X.4.2.1.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Ambush (2.X.2.6.1.1)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Forward Edge of Battle Area (2.X.2.4.2.1)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Line of Contact (2.X.2.1.2.3)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Fire Support Coordination Line (2.X.4.2.2.1)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Principle Direction of Fire (2.X.2.4.2.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Search Area/Reconnaissance Area (2.X.2.1.3.9)");
            graphic.setModifier(SymbologyConstants.SYMBOL_INDICATOR, "SFGPEWRH--MTUSG");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Forward Line of Own Troops (2.X.2.1.2.2)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Direction of Attack, Aviation (2.X.2.5.2.2.1)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Infiltration Lane (2.X.2.5.2.4)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Axis of Advance for Feint (2.X.2.3.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Holding Line (2.X.2.6.1.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Direction of Attack for Feint (2.X.2.3.3)");
        ...
        protected void createAreaGraphics(RenderableLayer layer) {
            ...
            graphic.set(Keys.DISPLAY_NAME, "Assembly Area (2.X.2.1.3.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Fortified Area (2.X.2.1.3.4)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Airfield Zone (2.X.2.1.3.11)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Restricted Operations Zone (2.X.2.2.3.1)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Weapons Free Zone (2.X.2.2.3.5)");
            graphic.setText("(Unit ID)");
            ...
            circle.set(Keys.DISPLAY_NAME, "Circular Target (2.X.4.3.1.2)");
            ...
            quad.setText("AB0176");
            quad.set(Keys.DISPLAY_NAME, "Rectangular Target (2.X.4.3.1.1)");
            layer.add(quad);
            ...
            circle.set(Keys.DISPLAY_NAME, "Position Area for Artillery (2.X.4.3.2.6.2)");
            layer.add(circle);
            ...
            quad.set(Keys.DISPLAY_NAME, "Position Area for Artillery (2.X.4.3.2.6.1)");
            layer.add(quad);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Weapon/Sensor Range Fan (2.X.4.3.4.1)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Weapon/Sensor Range Fan (2.X.4.3.4.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Restrictive Fire Area (2.X.4.3.2.5.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Fire Support Area (2.X.4.3.2.1.3)");
            graphic.setText("GREEN");
            graphic.setModifier(SymbologyConstants.DATE_TIME_GROUP, Arrays.asList("051030", "051600Z"));
            layer.add(graphic);
            ...
            graphic.setModifier(SymbologyConstants.DISTANCE, 5000.0);
            graphic.set(Keys.DISPLAY_NAME, "Sensor Zone");
            graphic.setText("Q37");
            graphic.setModifier(SymbologyConstants.DATE_TIME_GROUP, Arrays.asList("051030", "051600Z"));
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Call for Fire Zone (2.X.4.3.3.2.1)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Series or Group of Targets (2.X.4.3.1.3)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Airhead (2.X.2.6.2.2)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Minimum Safe Distance Zones (2.X.3.4.1)");
            layer.add(graphic);
            ...
            circle.set(Keys.DISPLAY_NAME, "Pull-Up Point (2.X.2.2.1.3)");
            layer.add(circle);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Attack by Fire Position (2.X.2.5.3.3)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Support by Fire Position (2.X.2.5.3.4)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Biologically Contaminated Area (2.X.3.4.5)");
            layer.add(graphic);

            graphic = factory.createPoint("GFMPNEB-------X", Position.fromDegrees(34.5059, -117.2020), null);
            graphic.set(Keys.DISPLAY_NAME, "Biological Release Event (2.X.3.4.7.1)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Battle Position, Prepared but not Occupied (2.X.2.4.3.1.1)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Encirclement (2.X.2.6.2.3)");
            layer.add(graphic);
            ...
            graphic.set(Keys.DISPLAY_NAME, "Dose Rate Contour Line (2.X.3.4.9)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "General Area (2.X.2.1.3.1)");
            ...
            graphic.set(Keys.DISPLAY_NAME, "Limited Access Area (2.X.2.1.3.10)");
            graphic.setModifier(SymbologyConstants.SYMBOL_INDICATOR, "SFGPUCI--------");
            layer.add(graphic);
