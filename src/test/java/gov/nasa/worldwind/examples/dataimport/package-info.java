 ...
 * <em>raster data</em>. WorldWind can import many formats of raster data, including but not limited to JPEG,
 * JPEG-2000, PNG, and DTED, and GeoTIFF for both imagery and elevations. Data can be imported from a local or network
 * disk, or in many cases directly from a network URL. This overview describes the import process and identifies example
 * programs showing exactly how import is done.</p>
 *
 * <p>
 ...
 * gov.nasa.worldwind.examples.dataimport.InstallImagery} and {@link
 * gov.nasa.worldwind.examples.dataimport.InstallElevations} shows how to use this file to create a layer and an
 * elevation model, respectively.</p>
 *
 * <h3>Data Installation Examples</h3>
 *
 * <p>
 * The example {@link gov.nasa.worldwind.examples.dataimport.InstallImagery} shows how to install imagery and use it to
 * create a {@link gov.nasa.worldwind.layers.TiledImageLayer}. The example {@link
 * gov.nasa.worldwind.examples.dataimport.InstallElevations} shows how to install elevations and use them to create an
