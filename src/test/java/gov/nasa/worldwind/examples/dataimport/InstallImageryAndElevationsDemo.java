 ...
 * <code>{@link gov.nasa.worldwind.globes.ElevationModel}</code>. The application also illustrates how to visualize
 * data that has been installed during a previous session.
 * <p>
...
//                continue;
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame {
        ...
        public AppFrame() {
            this.installedDataFrame = new InstalledDataFrame(Configuration.data, this.wwd());
