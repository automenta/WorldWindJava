        ...
        protected void loadAirspacesFromPath(String path, Collection<Airspace> airspaces) {
            ...
            try {
                ...
                for (Enumeration<? extends ZipEntry> e = zipFile.entries(); e.hasMoreElements();
                    ...
                    if (!(name.startsWith("gov.nasa.worldwind.examples.render.airspaces") && name.endsWith(".xml"))) {
                        continue;
                    }
            ...
            Thread t = new Thread(() -> {
                ...
                try {
                    File[] files = dir.listFiles(
                        (File dir1, String name) -> name.startsWith("gov.nasa.worldwind.examples.render.airspaces")
                            && name.endsWith(".xml"));
