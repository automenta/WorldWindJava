 ...
 * by calling {@link #addMessageListener(MessageListener)}.
 * <p>
 ...
 * #setInteriorColor(Color)} and {@link #setBorderColor(Color)} to specify the rectangle's interior
...
public class ScreenSelector extends WWObjectImpl implements MouseListener, MouseMotionListener, SelectListener {
    ...
    protected final Collection<MessageListener> messageListeners = new ArrayList<>();
    ...
    protected Point limitPointToWorldWindow(Point point) {
        Rectangle viewport = this.getWwd().view().getViewport();
    ...
    protected void selectObjects(Collection<?> list) {
